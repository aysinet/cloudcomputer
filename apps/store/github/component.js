(function (Vue) {
  ...
  const LANGS = {
    en: {
      ...
      initReadme:'Initialize with README',
      create:'Create',
      cancel:'Cancel',
      newBranch:'New Branch',
      createBranch:'Create Branch',
      branchName:'Branch name',
      branchNamePlaceholder:'feature/my-feature',
      from:'From',
      open:'Open',
      closed:'Closed',
      newIssue:'New Issue',
      ...
      initRepo:'Init Repo',
      refresh:'Refresh',
      noLocalRepos:'No local repositories found.',
      status:'Status',
      staged:'Staged',
      modified:'Modified',
      untracked:'Untracked',
      ...
      tokenRequiredDesc:'Please configure your GitHub personal access token in settings.',
      goSettings:'Go to Settings',
      githubToken:'GitHub Token',
      tokenHelp:'Personal access token with repo, gist scopes. Stored on server for your user only.',
      tokenPlaceholder:'ghp_… or github_pat_…',
      show:'Show',
      hide:'Hide',
      createToken:'Create token on GitHub →',
      defaultClonePath:'Default Clone Path',
      clonePathHelp:'Relative to your user files directory. Empty = root.',
      clonePathPlaceholder:'e.g. projects',
      saving:'Saving…',
      save:'Save',
      cloneRepo:'Clone Repository',
      repoUrl:'Repository URL',
      targetPath:'Target Path',
      initPathPlaceholder:'e.g. my-project',
      init:'Initialize',
      deleteConfirm:'Are you sure you want to delete this repository?',
      code:'Code',
      commits:'Commits',
      branches:'Branches',
      issues:'Issues',
    ...
    tr: {
      ...
      forks:'Fork',
      newRepo:'Yeni Depo',
      noRepos:'Depo bulunamadı.',
      clone:'Klonla',
      delete:'Sil',
      back:'Geri',
      createRepo:'Depo Oluştur',
      repoName:'Ad',
      repoNamePlaceholder:'projem',
      description:'Açıklama',
      initReadme:'README ile başlat',
      create:'Oluştur',
      cancel:'İptal',
      newBranch:'Yeni Dal',
      createBranch:'Dal Oluştur',
      branchName:'Dal adı',
      branchNamePlaceholder:'feature/ozellik',
      from:'Kaynak',
      open:'Açık',
      closed:'Kapalı',
      newIssue:'Yeni Konu',
      createIssue:'Konu Oluştur',
      issueTitle:'Başlık',
      issueBody:'İçerik',
      noIssues:'Konu yok.',
      noCommits:'Commit yok.',
      noPRs:'Pull request yok.',
      closeIssue:'Konuyu Kapat',
      reopenIssue:'Yeniden Aç',
      comment:'Yorum',
      addComment:'Yorum yazın…',
      newGist:'Yeni Gist',
      createGist:'Gist Oluştur',
      noGists:'Gist yok.',
      files:'dosya',
      fileContent:'Dosya içeriği…',
      addFile:'Dosya ekle',
      localGit:'Yerel Git Depoları',
      initRepo:'Depo Başlat',
      refresh:'Yenile',
      noLocalRepos:'Yerel depo bulunamadı.',
      status:'Durum',
      staged:'Hazırlanmış',
      modified:'Değiştirilmiş',
      untracked:'Takip edilmeyen',
      workingClean:'Çalışma dizini temiz',
      commitMsg:'Commit mesajı…',
      commit:'Commit',
      addAll:'Tümünü Ekle',
      pull:'Çek',
      push:'Gönder',
      ...
      addRemote:'Uzak Ekle',
      output:'Çıktı',
      tokenRequired:'GitHub Token Gerekli',
      tokenRequiredDesc:'Ayarlardan GitHub kişisel erişim tokenınızı yapılandırın.',
      goSettings:'Ayarlara Git',
      githubToken:'GitHub Token',
      tokenHelp:'repo, gist kapsamlı kişisel erişim jetonu. Sunucuda sadece sizin kullanıcınız için saklanır.',
      tokenPlaceholder:'ghp_… veya github_pat_…',
      show:'Göster',
      hide:'Gizle',
      createToken:'GitHub\'da token oluştur →',
      defaultClonePath:'Varsayılan Klonlama Yolu',
      clonePathHelp:'Kullanıcı dosya dizininize göre. Boş = kök.',
      clonePathPlaceholder:'örn. projeler',
      saving:'Kaydediliyor…',
      save:'Kaydet',
      cloneRepo:'Depoyu Klonla',
      repoUrl:'Depo URL\'si',
      targetPath:'Hedef Yol',
      initPathPlaceholder:'örn. projem',
      init:'Başlat',
      deleteConfirm:'Bu depoyu silmek istediğinizden emin misiniz?',
      code:'Kod',
      commits:'Commitler',
      branches:'Dallar',
      issues:'Konular',
    ...
    de: {
      ...
      repoName:'Name',
      repoNamePlaceholder:'mein-projekt',
      description:'Beschreibung',
      initReadme:'Mit README initialisieren',
      create:'Erstellen',
      cancel:'Abbrechen',
      newBranch:'Neuer Branch',
      createBranch:'Branch erstellen',
      branchName:'Branch-Name',
      branchNamePlaceholder:'feature/mein-feature',
      from:'Von',
      open:'Offen',
      closed:'Geschlossen',
      ...
      noPRs:'Keine Pull Requests.',
      closeIssue:'Issue schließen',
      reopenIssue:'Wiedereröffnen',
      comment:'Kommentar',
      ...
      localGit:'Lokale Git-Repositories',
      initRepo:'Repo initialisieren',
      refresh:'Aktualisieren',
      noLocalRepos:'Keine lokalen Repos gefunden.',
      status:'Status',
      staged:'Bereitgestellt',
      modified:'Geändert',
      untracked:'Unverfolgt',
      workingClean:'Arbeitsverzeichnis sauber',
      commitMsg:'Commit-Nachricht…',
      commit:'Commit',
      ...
      output:'Ausgabe',
      tokenRequired:'GitHub-Token erforderlich',
      tokenRequiredDesc:'Bitte konfigurieren Sie Ihr GitHub-Token in den Einstellungen.',
      goSettings:'Zu Einstellungen',
      githubToken:'GitHub-Token',
      tokenHelp:'Persönliches Zugriffstoken mit repo, gist Berechtigung.',
      tokenPlaceholder:'ghp_… oder github_pat_…',
      show:'Zeigen',
      hide:'Verbergen',
      createToken:'Token auf GitHub erstellen →',
      defaultClonePath:'Standard-Klonpfad',
      clonePathHelp:'Relativ zu Ihrem Benutzerdateiverzeichnis.',
      clonePathPlaceholder:'z.B. projekte',
      saving:'Speichern…',
      save:'Speichern',
      cloneRepo:'Repository klonen',
      repoUrl:'Repository-URL',
      targetPath:'Zielpfad',
      initPathPlaceholder:'z.B. mein-projekt',
      init:'Initialisieren',
      deleteConfirm:'Möchten Sie dieses Repository wirklich löschen?',
      code:'Code',
      commits:'Commits',
      branches:'Branches',
      issues:'Issues',
    ...
    fr: {
      ...
      repoName:'Nom',
      repoNamePlaceholder:'mon-projet',
      description:'Description',
      initReadme:'Initialiser avec README',
      create:'Créer',
      cancel:'Annuler',
      newBranch:'Nouvelle branche',
      createBranch:'Créer une branche',
      branchName:'Nom de branche',
      branchNamePlaceholder:'feature/ma-feature',
      from:'Depuis',
      open:'Ouvert',
      closed:'Fermé',
      ...
      issueTitle:'Titre',
      issueBody:'Contenu',
      noIssues:'Aucun ticket.',
      noCommits:'Aucun commit.',
      noPRs:'Aucune pull request.',
      closeIssue:'Fermer le ticket',
      reopenIssue:'Rouvrir',
      comment:'Commenter',
      addComment:'Écrire un commentaire…',
      newGist:'Nouveau Gist',
      createGist:'Créer un Gist',
      noGists:'Aucun gist.',
      files:'fichiers',
      fileContent:'Contenu du fichier…',
      addFile:'Ajouter un fichier',
      localGit:'Dépôts Git locaux',
      initRepo:'Initialiser',
      refresh:'Actualiser',
      noLocalRepos:'Aucun dépôt local trouvé.',
      status:'Statut',
      staged:'Indexé',
      modified:'Modifié',
      untracked:'Non suivi',
      workingClean:'Répertoire de travail propre',
      commitMsg:'Message de commit…',
      commit:'Commit',
      addAll:'Tout ajouter',
      pull:'Tirer',
      push:'Pousser',
      ...
      addRemote:'Ajouter distant',
      output:'Sortie',
      tokenRequired:'Token GitHub requis',
      tokenRequiredDesc:'Veuillez configurer votre token dans les paramètres.',
      goSettings:'Paramètres',
      githubToken:'Token GitHub',
      tokenHelp:'Token d\'accès personnel avec les portées repo, gist.',
      tokenPlaceholder:'ghp_… ou github_pat_…',
      show:'Afficher',
      hide:'Masquer',
      createToken:'Créer un token sur GitHub →',
      defaultClonePath:'Chemin de clonage par défaut',
      clonePathHelp:'Relatif à votre dossier de fichiers.',
      clonePathPlaceholder:'ex. projets',
      saving:'Enregistrement…',
      save:'Enregistrer',
      cloneRepo:'Cloner le dépôt',
      repoUrl:'URL du dépôt',
      targetPath:'Chemin cible',
      initPathPlaceholder:'ex. mon-projet',
      init:'Initialiser',
      deleteConfirm:'Voulez-vous vraiment supprimer ce dépôt?',
      code:'Code',
      commits:'Commits',
      branches:'Branches',
      issues:'Tickets',
    ...
    es: {
      ...
      forks:'Forks',
      newRepo:'Nuevo Repo',
      noRepos:'No se encontraron repos.',
      clone:'Clonar',
      delete:'Eliminar',
      back:'Volver',
      ...
      initReadme:'Inicializar con README',
      create:'Crear',
      cancel:'Cancelar',
      newBranch:'Nueva rama',
      createBranch:'Crear rama',
      branchName:'Nombre de rama',
      branchNamePlaceholder:'feature/mi-feature',
      from:'Desde',
      open:'Abierto',
      closed:'Cerrado',
      ...
      noPRs:'Sin pull requests.',
      closeIssue:'Cerrar Issue',
      reopenIssue:'Reabrir',
      comment:'Comentar',
      addComment:'Escribir comentario…',
      newGist:'Nuevo Gist',
      createGist:'Crear Gist',
      noGists:'Sin gists.',
      files:'archivos',
      fileContent:'Contenido del archivo…',
      addFile:'Añadir archivo',
      localGit:'Repos Git Locales',
      initRepo:'Iniciar Repo',
      refresh:'Actualizar',
      noLocalRepos:'No se encontraron repos locales.',
      status:'Estado',
      staged:'Preparado',
      modified:'Modificado',
      untracked:'Sin seguimiento',
      workingClean:'Directorio limpio',
      commitMsg:'Mensaje de commit…',
      commit:'Commit',
      addAll:'Añadir todo',
      pull:'Pull',
      push:'Push',
      ...
      output:'Salida',
      tokenRequired:'Token de GitHub requerido',
      tokenRequiredDesc:'Configure su token en los ajustes.',
      goSettings:'Ir a Ajustes',
      githubToken:'Token de GitHub',
      tokenHelp:'Token de acceso personal con alcance repo, gist.',
      tokenPlaceholder:'ghp_… o github_pat_…',
      show:'Mostrar',
      hide:'Ocultar',
      createToken:'Crear token en GitHub →',
      defaultClonePath:'Ruta de clonación por defecto',
      clonePathHelp:'Relativa a su carpeta de archivos.',
      clonePathPlaceholder:'ej. proyectos',
      saving:'Guardando…',
      save:'Guardar',
      cloneRepo:'Clonar Repositorio',
      repoUrl:'URL del repo',
      targetPath:'Ruta destino',
      initPathPlaceholder:'ej. mi-proyecto',
      init:'Inicializar',
      deleteConfirm:'¿Seguro que desea eliminar este repositorio?',
      code:'Código',
      commits:'Commits',
      branches:'Ramas',
      issues:'Issues',
    ...
    ru: {
      ...
      repoName:'Имя',
      repoNamePlaceholder:'мой-проект',
      description:'Описание',
      initReadme:'Инициализировать с README',
      create:'Создать',
      cancel:'Отмена',
      newBranch:'Новая ветка',
      createBranch:'Создать ветку',
      branchName:'Имя ветки',
      branchNamePlaceholder:'feature/моя-фича',
      from:'Из',
      open:'Открытые',
      closed:'Закрытые',
      ...
      issueBody:'Содержание',
      noIssues:'Нет issues.',
      noCommits:'Нет коммитов.',
      noPRs:'Нет pull requests.',
      closeIssue:'Закрыть Issue',
      reopenIssue:'Переоткрыть',
      comment:'Комментарий',
      addComment:'Написать комментарий…',
      newGist:'Новый Gist',
      createGist:'Создать Gist',
      noGists:'Нет gists.',
      files:'файлов',
      fileContent:'Содержимое файла…',
      addFile:'Добавить файл',
      localGit:'Локальные Git репозитории',
      initRepo:'Инициализация',
      refresh:'Обновить',
      noLocalRepos:'Нет локальных репозиториев.',
      status:'Статус',
      staged:'Подготовлено',
      modified:'Изменено',
      untracked:'Не отслеживается',
      workingClean:'Рабочее дерево чисто',
      ...
      push:'Push',
      log:'Журнал',
      remoteUrl:'URL удалённого',
      addRemote:'Добавить удалённый',
      output:'Вывод',
      tokenRequired:'Требуется GitHub токен',
      tokenRequiredDesc:'Настройте токен в настройках.',
      goSettings:'В настройки',
      githubToken:'GitHub Токен',
      tokenHelp:'Персональный токен доступа с правами repo, gist.',
      tokenPlaceholder:'ghp_… или github_pat_…',
      show:'Показать',
      hide:'Скрыть',
      createToken:'Создать токен на GitHub →',
      defaultClonePath:'Путь клонирования по умолчанию',
      clonePathHelp:'Относительно папки с файлами.',
      clonePathPlaceholder:'напр. проекты',
      saving:'Сохранение…',
      save:'Сохранить',
      cloneRepo:'Клонировать репозиторий',
      repoUrl:'URL репозитория',
      targetPath:'Целевой путь',
      initPathPlaceholder:'напр. мой-проект',
      init:'Инициализировать',
      deleteConfirm:'Вы уверены, что хотите удалить этот репозиторий?',
      code:'Код',
      commits:'Коммиты',
      branches:'Ветки',
      issues:'Issues',
