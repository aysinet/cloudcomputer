(function (Vue) {
  ...
  const LANGS = {
    ...
    zh: { repos: 'Repos', git: 'Local Git', gists: 'Gists', settings: 'Settings', loading: 'Loading…', searchRepos: 'Search repositories…', all: 'All', owned: 'Owned', public: 'Public', private: 'Private', forks: 'Forks', newRepo: 'New Repo', noRepos: 'No repositories found.', clone: 'Clone', delete: 'Delete', back: 'Back', createRepo: 'Create Repository', repoName: 'Name', repoNamePlaceholder: 'my-project', description: 'Description', initReadme: 'Initialize with README', create: 'Create', cancel: 'Cancel', newBranch: 'New Branch', createBranch: 'Create Branch', branchName: 'Branch name', branchNamePlaceholder: 'feature/my-feature', from: 'From', open: 'Open', closed: 'Closed', newIssue: 'New Issue', createIssue: 'Create Issue', issueTitle: 'Title', issueBody: 'Body', noIssues: 'No issues.', noCommits: 'No commits.', noPRs: 'No pull requests.', closeIssue: 'Close Issue', reopenIssue: 'Reopen Issue', comment: 'Comment', addComment: 'Write a comment…', newGist: 'New Gist', createGist: 'Create Gist', noGists: 'No gists.', files: 'files', fileContent: 'File content…', addFile: 'Add file', localGit: 'Local Git Repositories', initRepo: 'Init Repo', refresh: 'Refresh', noLocalRepos: 'No local repositories found.', status: 'Status', staged: 'Staged', modified: 'Modified', untracked: 'Untracked', workingClean: 'Working tree clean', commitMsg: 'Commit message…', commit: 'Commit', addAll: 'Add All', pull: 'Pull', push: 'Push', log: 'Log', remoteUrl: 'Remote URL', addRemote: 'Add Remote', output: 'Output', tokenRequired: 'GitHub Token Required', tokenRequiredDesc: 'Please configure your GitHub personal access token in settings.', goSettings: 'Go to Settings', githubToken: 'GitHub Token', tokenHelp: 'Personal access token with repo, gist scopes. Stored on server for your user only.', tokenPlaceholder: 'ghp_… or github_pat_…', show: 'Show', hide: 'Hide', createToken: 'Create token on GitHub →', defaultClonePath: 'Default Clone Path', clonePathHelp: 'Relative to your user files directory. Empty = root.', clonePathPlaceholder: 'e.g. projects', saving: 'Saving…', save: 'Save', cloneRepo: 'Clone Repository', repoUrl: 'Repository URL', targetPath: 'Target Path', initPathPlaceholder: 'e.g. my-project', init: 'Initialize', deleteConfirm: 'Are you sure you want to delete this repository?', code: 'Code', commits: 'Commits', branches: 'Branches', issues: 'Issues', pullRequests: 'Pull Requests' },
    ja: { repos: 'Repos', git: 'Local Git', gists: 'Gists', settings: 'Settings', loading: 'Loading…', searchRepos: 'Search repositories…', all: 'All', owned: 'Owned', public: 'Public', private: 'Private', forks: 'Forks', newRepo: 'New Repo', noRepos: 'No repositories found.', clone: 'Clone', delete: 'Delete', back: 'Back', createRepo: 'Create Repository', repoName: 'Name', repoNamePlaceholder: 'my-project', description: 'Description', initReadme: 'Initialize with README', create: 'Create', cancel: 'Cancel', newBranch: 'New Branch', createBranch: 'Create Branch', branchName: 'Branch name', branchNamePlaceholder: 'feature/my-feature', from: 'From', open: 'Open', closed: 'Closed', newIssue: 'New Issue', createIssue: 'Create Issue', issueTitle: 'Title', issueBody: 'Body', noIssues: 'No issues.', noCommits: 'No commits.', noPRs: 'No pull requests.', closeIssue: 'Close Issue', reopenIssue: 'Reopen Issue', comment: 'Comment', addComment: 'Write a comment…', newGist: 'New Gist', createGist: 'Create Gist', noGists: 'No gists.', files: 'files', fileContent: 'File content…', addFile: 'Add file', localGit: 'Local Git Repositories', initRepo: 'Init Repo', refresh: 'Refresh', noLocalRepos: 'No local repositories found.', status: 'Status', staged: 'Staged', modified: 'Modified', untracked: 'Untracked', workingClean: 'Working tree clean', commitMsg: 'Commit message…', commit: 'Commit', addAll: 'Add All', pull: 'Pull', push: 'Push', log: 'Log', remoteUrl: 'Remote URL', addRemote: 'Add Remote', output: 'Output', tokenRequired: 'GitHub Token Required', tokenRequiredDesc: 'Please configure your GitHub personal access token in settings.', goSettings: 'Go to Settings', githubToken: 'GitHub Token', tokenHelp: 'Personal access token with repo, gist scopes. Stored on server for your user only.', tokenPlaceholder: 'ghp_… or github_pat_…', show: 'Show', hide: 'Hide', createToken: 'Create token on GitHub →', defaultClonePath: 'Default Clone Path', clonePathHelp: 'Relative to your user files directory. Empty = root.', clonePathPlaceholder: 'e.g. projects', saving: 'Saving…', save: 'Save', cloneRepo: 'Clone Repository', repoUrl: 'Repository URL', targetPath: 'Target Path', initPathPlaceholder: 'e.g. my-project', init: 'Initialize', deleteConfirm: 'Are you sure you want to delete this repository?', code: 'Code', commits: 'Commits', branches: 'Branches', issues: 'Issues', pullRequests: 'Pull Requests' },
    it: { repos: 'Repos', git: 'Local Git', gists: 'Gists', settings: 'Settings', loading: 'Loading…', searchRepos: 'Search repositories…', all: 'All', owned: 'Owned', public: 'Public', private: 'Private', forks: 'Forks', newRepo: 'New Repo', noRepos: 'No repositories found.', clone: 'Clone', delete: 'Delete', back: 'Back', createRepo: 'Create Repository', repoName: 'Name', repoNamePlaceholder: 'my-project', description: 'Description', initReadme: 'Initialize with README', create: 'Create', cancel: 'Cancel', newBranch: 'New Branch', createBranch: 'Create Branch', branchName: 'Branch name', branchNamePlaceholder: 'feature/my-feature', from: 'From', open: 'Open', closed: 'Closed', newIssue: 'New Issue', createIssue: 'Create Issue', issueTitle: 'Title', issueBody: 'Body', noIssues: 'No issues.', noCommits: 'No commits.', noPRs: 'No pull requests.', closeIssue: 'Close Issue', reopenIssue: 'Reopen Issue', comment: 'Comment', addComment: 'Write a comment…', newGist: 'New Gist', createGist: 'Create Gist', noGists: 'No gists.', files: 'files', fileContent: 'File content…', addFile: 'Add file', localGit: 'Local Git Repositories', initRepo: 'Init Repo', refresh: 'Refresh', noLocalRepos: 'No local repositories found.', status: 'Status', staged: 'Staged', modified: 'Modified', untracked: 'Untracked', workingClean: 'Working tree clean', commitMsg: 'Commit message…', commit: 'Commit', addAll: 'Add All', pull: 'Pull', push: 'Push', log: 'Log', remoteUrl: 'Remote URL', addRemote: 'Add Remote', output: 'Output', tokenRequired: 'GitHub Token Required', tokenRequiredDesc: 'Please configure your GitHub personal access token in settings.', goSettings: 'Go to Settings', githubToken: 'GitHub Token', tokenHelp: 'Personal access token with repo, gist scopes. Stored on server for your user only.', tokenPlaceholder: 'ghp_… or github_pat_…', show: 'Show', hide: 'Hide', createToken: 'Create token on GitHub →', defaultClonePath: 'Default Clone Path', clonePathHelp: 'Relative to your user files directory. Empty = root.', clonePathPlaceholder: 'e.g. projects', saving: 'Saving…', save: 'Save', cloneRepo: 'Clone Repository', repoUrl: 'Repository URL', targetPath: 'Target Path', initPathPlaceholder: 'e.g. my-project', init: 'Initialize', deleteConfirm: 'Are you sure you want to delete this repository?', code: 'Code', commits: 'Commits', branches: 'Branches', issues: 'Issues', pullRequests: 'Pull Requests' }
  };
