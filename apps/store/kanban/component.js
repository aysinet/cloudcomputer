  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        noBoards:'Henüz pano yok. Yeni bir pano oluşturun.',
        importTodos:'Todo Kayıtlarını Aktar',
        importSuccess:'aktarıldı',
        importEmpty:'Aktarılacak todo bulunamadı',
        selectColumn:'Hangi kolona aktarılsın?',
        low:'Düşük',
        medium:'Orta',
        high:'Yüksek',
        critical:'Kritik',
        wipLimit:'WIP Limiti',
        cards:'kart',
        renameBoard:'Panoyu Yeniden Adlandır',
      ...
      en: {
        ...
        noBoards:'No boards yet. Create a new board.',
        importTodos:'Import Todo Items',
        importSuccess:'imported',
        importEmpty:'No todos to import',
        selectColumn:'Import to which column?',
        low:'Low',
        medium:'Medium',
        high:'High',
        critical:'Critical',
      ...
      de: {
        ...
        noBoards:'Noch keine Tafeln. Erstellen Sie eine neue Tafel.',
        importTodos:'Todo-Einträge importieren',
        importSuccess:'importiert',
        importEmpty:'Keine Todos zum Importieren',
        selectColumn:'In welche Spalte importieren?',
        low:'Niedrig',
        medium:'Mittel',
        high:'Hoch',
        critical:'Kritisch',
      ...
      fr: {
        ...
        noBoards:'Aucun tableau. Créez un nouveau tableau.',
        importTodos:'Importer les tâches',
        importSuccess:'importées',
        importEmpty:'Aucune tâche à importer',
        selectColumn:'Importer dans quelle colonne ?',
        low:'Basse',
        medium:'Moyenne',
        high:'Haute',
        critical:'Critique',
      ...
      es: {
        ...
        noBoards:'No hay tableros. Cree un nuevo tablero.',
        importTodos:'Importar tareas',
        importSuccess:'importadas',
        importEmpty:'No hay tareas para importar',
        selectColumn:'¿Importar a qué columna?',
        low:'Baja',
        medium:'Media',
        high:'Alta',
        critical:'Crítica',
      ...
      ru: {
        ...
        noBoards:'Нет досок. Создайте новую доску.',
        importTodos:'Импорт задач',
        importSuccess:'импортировано',
        importEmpty:'Нет задач для импорта',
        selectColumn:'В какую колонку импортировать?',
        low:'Низкий',
        medium:'Средний',
        high:'Высокий',
      ...
      zh: {
        ...
        noBoards:'暂无面板。请创建新面板。',
        importTodos:'导入待办事项',
        importSuccess:'已导入',
        importEmpty:'无待办事项可导入',
        selectColumn:'导入到哪一列？',
        low:'低',
        medium:'中',
        high:'高',
      ...
      ja: {
        ...
        noBoards:'ボードがありません。新しいボードを作成してください。',
        importTodos:'Todoをインポート',
        importSuccess:'インポート済',
        importEmpty:'インポートするTodoがありません',
        selectColumn:'どの列にインポートしますか？',
        low:'低',
        medium:'中',
        high:'高',
        critical:'緊急',
      ...
      it: {
        ...
        noBoards:'Nessuna bacheca. Crea una nuova bacheca.',
        importTodos:'Importa attività',
        importSuccess:'importate',
        importEmpty:'Nessuna attività da importare',
        selectColumn:'In quale colonna importare?',
        low:'Bassa',
        medium:'Media',
        high:'Alta',
        critical:'Critica',
