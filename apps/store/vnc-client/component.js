(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      name:'Bağlantı Adı',
      connectionName:'Bağlantı adı girin',
      fullscreen:'Tam Ekran',
      screenshot:'Ekran Görüntüsü',
      clipboardSync:'Pano Senkronizasyonu',
      scaling:'Ölçekleme',
      quality:'Kalite',
      sendCtrlAltDel:'Ctrl+Alt+Del Gönder',
      reconnect:'Yeniden Bağlan',
      status:'Durum',
      latency:'Gecikme',
      viewOnly:'Yalnızca İzle',
      localScaling:'Yerel Ölçekleme',
      recent:'Son Bağlantılar',
      quickConnect:'Hızlı Bağlantı',
      loadingNoVNC:'noVNC yükleniyor...',
      loadError:'noVNC yüklenemedi',
    ...
    en: {
      ...
      hostRequired:'Server address required',
      ...
      loadingNoVNC:'Loading noVNC...',
      loadError:'Failed to load noVNC',
    ...
    de: {
      ...
      hostRequired:'Serveradresse erforderlich',
      ...
      connectionName:'Verbindungsname eingeben',
      fullscreen:'Vollbild',
      screenshot:'Screenshot',
      clipboardSync:'Zwischenablage-Sync',
      scaling:'Skalierung',
      quality:'Qualität',
      ...
      localScaling:'Lokale Skalierung',
      recent:'Letzte Verbindungen',
      quickConnect:'Schnellverbindung',
      loadingNoVNC:'noVNC wird geladen...',
      loadError:'noVNC konnte nicht geladen werden',
    ...
    fr: {
      ...
      hostRequired:'Adresse du serveur requise',
      ...
      connectionName:'Entrez le nom de la connexion',
      fullscreen:'Plein écran',
      screenshot:'Capture d\'écran',
      clipboardSync:'Sync presse-papiers',
      ...
      localScaling:'Mise à l\'échelle locale',
      recent:'Connexions récentes',
      quickConnect:'Connexion rapide',
      loadingNoVNC:'Chargement de noVNC...',
      loadError:'Échec du chargement de noVNC',
    ...
    es: {
      ...
      hostRequired:'Dirección del servidor requerida',
      savedConnections:'Conexiones guardadas',
      save:'Guardar conexión',
      delete:'Eliminar',
      noSaved:'Sin conexiones guardadas',
      name:'Nombre de conexión',
      connectionName:'Ingrese nombre de conexión',
      fullscreen:'Pantalla completa',
      screenshot:'Captura de pantalla',
      clipboardSync:'Sincronizar portapapeles',
      scaling:'Escalado',
      quality:'Calidad',
      ...
      latency:'Latencia',
      viewOnly:'Solo ver',
      localScaling:'Escalado local',
      recent:'Conexiones recientes',
      quickConnect:'Conexión rápida',
      loadingNoVNC:'Cargando noVNC...',
      loadError:'Error al cargar noVNC',
    ...
    ru: {
      ...
      localScaling:'Локальное масштабирование',
      recent:'Последние подключения',
      quickConnect:'Быстрое подключение',
      loadingNoVNC:'Загрузка noVNC...',
      loadError:'Не удалось загрузить noVNC',
    ...
    ja: {
      ...
      scaling:'スケーリング',
      quality:'画質',
      sendCtrlAltDel:'Ctrl+Alt+Del送信',
      reconnect:'再接続',
      status:'状態',
      latency:'遅延',
      viewOnly:'表示のみ',
      localScaling:'ローカルスケーリング',
      recent:'最近',
      quickConnect:'クイック接続',
      loadingNoVNC:'noVNC読込中...',
      loadError:'読込エラー',
    ...
    it: {
      ...
      screenshot:'Screenshot',
      clipboardSync:'Sincronizza appunti',
      scaling:'Ridimensionamento',
      quality:'Qualità',
      sendCtrlAltDel:'Invia Ctrl+Alt+Del',
      reconnect:'Riconnetti',
      status:'Stato',
      latency:'Latenza',
      viewOnly:'Solo visualizzazione',
      localScaling:'Ridimensionamento locale',
      recent:'Recenti',
      quickConnect:'Connessione rapida',
      loadingNoVNC:'Caricamento noVNC...',
      loadError:'Errore caricamento',
      wsProxy:'Proxy WebSocket',
