  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        clipName:'Klip Adı',
        trimStart:'Başlangıç Kırpma',
        trimEnd:'Bitiş Kırpma',
        speed:'Hız',
        volume:'Ses',
        timeline:'Zaman Çizelgesi',
        clips:'klip',
        emptyTimeline:'Medya eklemek için tıklayın',
        addMediaHint:'Video eklemek için tıklayın',
        videos:'Videolar',
        browse:'Gözat',
        noFiles:'Dosya bulunamadı',
        uploadDevice:'Cihazdan Yükle',
        uploading:'Yükleniyor...',
        uploadSuccess:'Video yüklendi',
        uploadFail:'Yükleme başarısız',
        uploadHint:'Bilgisayarınızdan video seçin',
        exportTitle:'Video Dışa Aktar',
        filename:'Dosya Adı',
        resolution:'Çözünürlük',
        saveLocation:'Kayıt Yeri',
        videoFolder:'Video Klasörü',
        downloadLocal:'Bilgisayara İndir',
        cancel:'İptal',
        ...
        add:'Ekle',
        textOverlays:'Metin Katmanları',
        posTop:'Üst',
        posCenter:'Orta',
        posBottom:'Alt',
        success:'Başarılı',
        error:'Hata',
        exported:'Video kaydedildi',
      ...
      en: {
        ...
        timeline:'Timeline',
        clips:'clips',
        emptyTimeline:'Click to add media',
        addMediaHint:'Click to add a video',
        videos:'Videos',
        browse:'Browse',
        ...
        uploadHint:'Select a video from your computer',
        exportTitle:'Export Video',
        filename:'File Name',
        resolution:'Resolution',
        saveLocation:'Save Location',
        videoFolder:'Video Folder',
        downloadLocal:'Download to Computer',
        cancel:'Cancel',
      ...
      de: {
        ...
        clipName:'Clipname',
        trimStart:'Anfang trimmen',
        trimEnd:'Ende trimmen',
        speed:'Geschwindigkeit',
        volume:'Lautstärke',
        timeline:'Zeitachse',
        clips:'Clips',
        emptyTimeline:'Klicken um Medien hinzuzufügen',
        addMediaHint:'Klicken um Video hinzuzufügen',
        videos:'Videos',
        browse:'Durchsuchen',
        noFiles:'Keine Dateien',
        uploadDevice:'Vom Gerät hochladen',
        uploading:'Wird hochgeladen...',
        uploadSuccess:'Video hochgeladen',
        uploadFail:'Upload fehlgeschlagen',
        uploadHint:'Video von Ihrem Computer auswählen',
        exportTitle:'Video exportieren',
        filename:'Dateiname',
        resolution:'Auflösung',
        saveLocation:'Speicherort',
        videoFolder:'Videoordner',
        downloadLocal:'Herunterladen',
        cancel:'Abbrechen',
        ...
        textColor:'Textfarbe',
        add:'Hinzufügen',
        textOverlays:'Textüberlagerungen',
        posTop:'Oben',
        posCenter:'Mitte',
        posBottom:'Unten',
        success:'Erfolgreich',
        error:'Fehler',
        exported:'Video gespeichert',
      ...
      fr: {
        ...
        trimStart:'Début du découpage',
        trimEnd:'Fin du découpage',
        speed:'Vitesse',
        volume:'Volume',
        timeline:'Chronologie',
        clips:'clips',
        emptyTimeline:'Cliquez pour ajouter un média',
        addMediaHint:'Cliquez pour ajouter une vidéo',
        videos:'Vidéos',
        browse:'Parcourir',
        noFiles:'Aucun fichier',
        uploadDevice:'Depuis l\'appareil',
        uploading:'Envoi en cours...',
        uploadSuccess:'Vidéo envoyée',
        uploadFail:'Échec de l\'envoi',
        uploadHint:'Sélectionner une vidéo depuis votre ordinateur',
        exportTitle:'Exporter la vidéo',
        filename:'Nom du fichier',
        resolution:'Résolution',
        saveLocation:'Emplacement',
        videoFolder:'Dossier vidéo',
        downloadLocal:'Télécharger',
        cancel:'Annuler',
        ...
        add:'Ajouter',
        textOverlays:'Superpositions de texte',
        posTop:'Haut',
        posCenter:'Centre',
        posBottom:'Bas',
        success:'Succès',
        error:'Erreur',
        exported:'Vidéo enregistrée',
      ...
      es: {
        ...
        clips:'clips',
        emptyTimeline:'Clic para agregar media',
        addMediaHint:'Clic para agregar un video',
        videos:'Videos',
        browse:'Explorar',
        noFiles:'No se encontraron archivos',
        uploadDevice:'Desde el dispositivo',
        uploading:'Subiendo...',
        uploadSuccess:'Video subido',
        uploadFail:'Error al subir',
        uploadHint:'Seleccione un video de su computadora',
        exportTitle:'Exportar video',
        filename:'Nombre del archivo',
        resolution:'Resolución',
        saveLocation:'Ubicación',
        videoFolder:'Carpeta de video',
        downloadLocal:'Descargar',
        cancel:'Cancelar',
        ...
        add:'Agregar',
        textOverlays:'Superposiciones de texto',
        posTop:'Arriba',
        posCenter:'Centro',
        posBottom:'Abajo',
        success:'Éxito',
        error:'Error',
        exported:'Video guardado',
      ...
      ru: {
        ...
        timeline:'Таймлайн',
        clips:'клипов',
        emptyTimeline:'Нажмите для добавления медиа',
        addMediaHint:'Нажмите для добавления видео',
        videos:'Видео',
        browse:'Обзор',
        noFiles:'Файлы не найдены',
        uploadDevice:'С устройства',
        uploading:'Загрузка...',
        uploadSuccess:'Видео загружено',
        uploadFail:'Ошибка загрузки',
        uploadHint:'Выберите видео с компьютера',
        exportTitle:'Экспорт видео',
        filename:'Имя файла',
        resolution:'Разрешение',
        saveLocation:'Место сохранения',
        videoFolder:'Папка видео',
        ...
        add:'Добавить',
        textOverlays:'Текстовые наложения',
        posTop:'Сверху',
        posCenter:'Центр',
        posBottom:'Снизу',
        success:'Успешно',
        error:'Ошибка',
        exported:'Видео сохранено',
        exporting:'Экспорт...',
        loading:'Загрузка...',
      ...
      ja: {
        ...
        timeline:'タイムライン',
        clips:'クリップ',
        emptyTimeline:'タイムラインが空です',
        addMediaHint:'メディアを追加して編集開始',
        videos:'動画',
        browse:'参照',
        noFiles:'ファイルなし',
        uploadDevice:'デバイスからアップロード',
        uploading:'アップロード中...',
        uploadSuccess:'動画がアップロードされました',
        uploadFail:'アップロード失敗',
        uploadHint:'コンピュータから動画を選択',
        exportTitle:'動画をエクスポート',
        filename:'ファイル名',
        resolution:'解像度',
        saveLocation:'保存先',
        videoFolder:'動画フォルダ',
      ...
      it: {
        ...
        timeline:'Timeline',
        clips:'Clip',
        emptyTimeline:'Timeline vuota',
        addMediaHint:'Aggiungi media per iniziare',
        videos:'Video',
        browse:'Sfoglia',
        noFiles:'Nessun file',
        uploadDevice:'Carica dal dispositivo',
        uploading:'Caricamento...',
        uploadSuccess:'Video caricato',
        uploadFail:'Caricamento fallito',
        uploadHint:'Seleziona un video dal tuo computer',
        exportTitle:'Esporta video',
        filename:'Nome file',
        resolution:'Risoluzione',
        saveLocation:'Posizione',
        videoFolder:'Cartella video',
        ...
        add:'Aggiungi',
        textOverlays:'Sovrapposizioni testo',
        posTop:'Alto',
        posCenter:'Centro',
        posBottom:'Basso',
        success:'Successo',
