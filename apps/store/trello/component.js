(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      getKey:'API anahtarını al',
      authToken:'Token al',
      selectBoard:'Bir pano seçin',
      refresh:'Yenile',
      open:'Trello\'da Aç',
      saved:'Kaydedildi',
      error:'Hata',
      noCredentials:'API anahtarı ve token gerekli',
      cardDetail:'Kart Detay',
      labels:'Etiketler',
      members:'Üyeler',
      done:'Tamamlandı',
    ...
    de: {
      ...
      authToken:'Token erhalten',
      selectBoard:'Board auswählen',
      refresh:'Aktualisieren',
      open:'In Trello öffnen',
      saved:'Gespeichert',
      error:'Fehler',
    ...
    fr: {
      ...
      authToken:'Obtenir le token',
      selectBoard:'Sélectionner un tableau',
      refresh:'Actualiser',
      open:'Ouvrir dans Trello',
      saved:'Enregistré',
      error:'Erreur',
    ...
    es: {
      ...
      authToken:'Obtener token',
      selectBoard:'Seleccionar tablero',
      refresh:'Actualizar',
      open:'Abrir en Trello',
      saved:'Guardado',
      error:'Error',
    ...
    ja: {
      ...
      loading:'読み込み中...',
      back:'戻る',
      configure:'TrelloのAPIキーとトークンを設定してください',
      getKey:'APIキーを取得',
      authToken:'トークンを取得',
      selectBoard:'ボードを選択',
      refresh:'更新',
    ...
    it: {
      ...
      deleteCard:'Archivia scheda',
      moveCard:'Sposta scheda',
      cardName:'Nome scheda',
      listName:'Nome lista',
      description:'Descrizione',
      dueDate:'Scadenza',
      noBoards:'Nessuna bacheca trovata',
      loading:'Caricamento...',
      back:'Indietro',
      configure:'Configura la tua chiave API e token Trello',
      getKey:'Ottieni chiave API',
      authToken:'Ottieni token',
      selectBoard:'Seleziona una bacheca',
      refresh:'Aggiorna',
      open:'Apri in Trello',
      saved:'Salvato',
      error:'Errore',
      noCredentials:'Chiave API e token richiesti',
      cardDetail:'Dettaglio scheda',
      labels:'Etichette',
      members:'Membri',
      done:'Fatto',
      notDone:'Non fatto'
