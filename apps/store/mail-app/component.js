  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        deleteAccountConfirm:'Bu hesabı silmek istediğinize emin misiniz?',
        email:'E-posta',
        password:'Şifre',
        name:'İsim',
        save:'Kaydet',
        ...
        sendSuccess:'Mail gönderildi',
        sendError:'Gönderme hatası',
        fetchMail:'Mailleri Al',
        fetching:'Alınıyor...',
        fetchSuccess:'yeni mail alındı',
        fetchError:'Alma hatası',
        noMails:'Mail yok',
        noAccount:'Hesap eklenmemiş',
        reply:'Yanıtla',
        forward:'İlet',
        deleteMsg:'Sil',
        markRead:'Okundu',
      ...
      en: {
        ...
        fetching:'Fetching...',
        fetchSuccess:'new mails fetched',
      ...
      de: {
        ...
        deleteAccountConfirm:'Möchten Sie dieses Konto wirklich löschen?',
        email:'E-Mail',
        password:'Passwort',
        name:'Name',
        save:'Speichern',
        ...
        fetchMail:'Mails abrufen',
        fetching:'Wird abgerufen...',
        fetchSuccess:'neue Mails abgerufen',
        fetchError:'Abruffehler',
        noMails:'Keine Mails',
        noAccount:'Kein Konto konfiguriert',
        reply:'Antworten',
      ...
      fr: {
        ...
        deleteAccountConfirm:'Voulez-vous vraiment supprimer ce compte ?',
        email:'E-mail',
        ...
        fetchSuccess:'nouveaux mails récupérés',
        fetchError:'Erreur de récupération',
        noMails:'Pas de mails',
      ...
      es: {
        ...
        deleteAccountConfirm:'¿Está seguro de que desea eliminar esta cuenta?',
        email:'Correo',
        password:'Contraseña',
        name:'Nombre',
        save:'Guardar',
        ...
        fetchMail:'Recibir correos',
        fetching:'Recibiendo...',
        fetchSuccess:'correos nuevos recibidos',
        fetchError:'Error de recepción',
        noMails:'Sin correos',
        noAccount:'Ninguna cuenta configurada',
        reply:'Responder',
        forward:'Reenviar',
        deleteMsg:'Eliminar',
      ...
      ru: {
        ...
        deleteAccountConfirm:'Вы действительно хотите удалить этот аккаунт?',
        email:'Email',
        password:'Пароль',
        name:'Имя',
        save:'Сохранить',
        ...
        fetchMail:'Получить почту',
        fetching:'Получение...',
        fetchSuccess:'новых писем получено',
        fetchError:'Ошибка получения',
        noMails:'Нет писем',
        noAccount:'Аккаунт не настроен',
        reply:'Ответить',
        forward:'Переслать',
        deleteMsg:'Удалить',
        markRead:'Прочитано',
      ...
      it: {
        ...
        deleteAccountConfirm:'Confermi eliminazione account?',
        email:'Email',
        password:'Password',
        name:'Nome',
        save:'Salva',
        ...
        fetchMail:'Ricevi posta',
        fetching:'Ricezione',
        fetchSuccess:'Ricezione riuscita',
        fetchError:'Errore ricezione',
        noMails:'Nessuna mail',
