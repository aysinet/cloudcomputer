  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        delete:'Sil',
        edit:'Düzenle',
        noMarkers:'Henüz işaret yok',
        noViews:'Henüz kayıtlı görünüm yok',
        clickToPlace:'Haritaya tıklayarak konum seçin',
        deleteConfirm:'Silmek istediğinize emin misiniz?',
        viewName:'Görünüm Adı',
        currentView:'Mevcut Görünüm',
        zoom:'Yakınlaştırma',
        osm:'OpenStreetMap',
        satellite:'Uydu (Google)',
        topo:'Topoğrafik',
        sidebar:'Panel',
        fitAll:'Tümünü Göster',
        myLocation:'Konumum',
        nameRequired:'Ad gerekli',
        coordRequired:'Koordinat gerekli',
        search:'Ara...',
        total:'Toplam'
      },
      en: {
        ...
        zoom:'Zoom',
        osm:'OpenStreetMap',
        satellite:'Satellite (Google)',
        topo:'Topographic',
        sidebar:'Panel',
        fitAll:'Fit All',
        myLocation:'My Location',
        nameRequired:'Name is required',
        coordRequired:'Coordinates required',
        search:'Search...',
        total:'Total'
      },
      de: {
      ...
      fr: {
        ...
        delete:'Supprimer',
        edit:'Modifier',
        noMarkers:'Pas encore de marqueurs',
        noViews:'Pas encore de vues sauvegardées',
        ...
        coordRequired:'Coordonnées requises',
        search:'Rechercher...',
        total:'Total'
      },
      es: {
        ...
        delete:'Eliminar',
        edit:'Editar',
        noMarkers:'Aún no hay marcadores',
        noViews:'Aún no hay vistas guardadas',
        clickToPlace:'Haga clic en el mapa para colocar un marcador',
        deleteConfirm:'¿Está seguro de que desea eliminar esto?',
        viewName:'Nombre de la vista',
        currentView:'Vista actual',
        zoom:'Zoom',
        osm:'OpenStreetMap',
        satellite:'Satélite (Google)',
        topo:'Topográfico',
        sidebar:'Panel',
        fitAll:'Mostrar todo',
        myLocation:'Mi ubicación',
        nameRequired:'El nombre es obligatorio',
        coordRequired:'Coordenadas requeridas',
        search:'Buscar...',
        total:'Total'
      },
      ru: {
        ...
        editMarker:'Редактировать маркер',
        ...
        delete:'Удалить',
        edit:'Редактировать',
        noMarkers:'Пока нет маркеров',
        noViews:'Пока нет сохранённых видов',
        clickToPlace:'Нажмите на карту, чтобы разместить маркер',
        deleteConfirm:'Вы уверены, что хотите удалить это?',
        viewName:'Название вида',
        currentView:'Текущий вид',
        zoom:'Масштаб',
        osm:'OpenStreetMap',
        satellite:'Спутник (Google)',
        topo:'Топографическая',
        sidebar:'Панель',
        fitAll:'Показать все',
        myLocation:'Моё местоположение',
        nameRequired:'Имя обязательно',
        coordRequired:'Координаты обязательны',
        search:'Поиск...',
        total:'Всего'
      },
      zh: {
      ...
      it: {
        ...
        delete:'Elimina',
        edit:'Modifica',
        noMarkers:'Nessun marcatore',
        noViews:'Nessuna vista',
        clickToPlace:'Clicca per posizionare',
        ...
        coordRequired:'Coordinate richieste',
        search:'Cerca',
        total:'Totale'
      },
      ar: {
