({
  setup() {
    ...
    const LANGS = {
      tr: {
        title:'Ses Kaydedici', record:'Kayıt', pause:'Duraklat', resume:'Devam',
        stop:'Durdur', recordings:'Kayıtlar', noRecordings:'Henüz kayıt yok',
        download:'İndir', delete:'Sil', connected:'Bağlı', disconnected:'Bağlantı yok',
        recordingState:'Kaydediliyor...', pausedState:'Duraklatıldı',
        success:'Başarılı', error:'Hata', saved:'Kayıt kaydedildi',
        deleted:'Kayıt silindi', micError:'Mikrofon erişimi reddedildi',
        deleteConfirm:'Bu kaydı silmek istediğinize emin misiniz?', cancel:'İptal'
      },
      en: {
        title:'Audio Recorder', record:'Record', pause:'Pause', resume:'Resume',
        stop:'Stop', recordings:'Recordings', noRecordings:'No recordings yet',
        download:'Download', delete:'Delete', connected:'Connected', disconnected:'Disconnected',
        recordingState:'Recording...', pausedState:'Paused',
        success:'Success', error:'Error', saved:'Recording saved',
        deleted:'Recording deleted', micError:'Microphone access denied',
        deleteConfirm:'Are you sure you want to delete this recording?', cancel:'Cancel'
      },
      de: {
        title:'Audiorekorder', record:'Aufnahme', pause:'Pause', resume:'Fortsetzen',
        stop:'Stopp', recordings:'Aufnahmen', noRecordings:'Noch keine Aufnahmen',
        download:'Herunterladen', delete:'Löschen', connected:'Verbunden', disconnected:'Getrennt',
        recordingState:'Aufnahme...', pausedState:'Pausiert',
        success:'Erfolgreich', error:'Fehler', saved:'Aufnahme gespeichert',
        deleted:'Aufnahme gelöscht', micError:'Mikrofonzugriff verweigert',
        deleteConfirm:'Möchten Sie diese Aufnahme wirklich löschen?', cancel:'Abbrechen'
      },
      fr: {
        title:'Enregistreur Audio', record:'Enregistrer', pause:'Pause', resume:'Reprendre',
        stop:'Arrêter', recordings:'Enregistrements', noRecordings:'Pas encore d\'enregistrements',
        download:'Télécharger', delete:'Supprimer', connected:'Connecté', disconnected:'Déconnecté',
        recordingState:'Enregistrement...', pausedState:'En pause',
        success:'Succès', error:'Erreur', saved:'Enregistrement sauvegardé',
        deleted:'Enregistrement supprimé', micError:'Accès au microphone refusé',
        deleteConfirm:'Êtes-vous sûr de vouloir supprimer cet enregistrement ?', cancel:'Annuler'
      },
      es: {
        title:'Grabadora de Audio', record:'Grabar', pause:'Pausar', resume:'Reanudar',
        stop:'Detener', recordings:'Grabaciones', noRecordings:'Aún no hay grabaciones',
        download:'Descargar', delete:'Eliminar', connected:'Conectado', disconnected:'Desconectado',
        recordingState:'Grabando...', pausedState:'En pausa',
        success:'Éxito', error:'Error', saved:'Grabación guardada',
        deleted:'Grabación eliminada', micError:'Acceso al micrófono denegado',
        deleteConfirm:'¿Estás seguro de que quieres eliminar esta grabación?', cancel:'Cancelar'
      },
      ru: {
        title:'Аудиорекордер', record:'Запись', pause:'Пауза', resume:'Продолжить',
        stop:'Стоп', recordings:'Записи', noRecordings:'Пока нет записей',
        download:'Скачать', delete:'Удалить', connected:'Подключено', disconnected:'Отключено',
        recordingState:'Запись...', pausedState:'Приостановлено',
