(function(Vue) {
  ...
  const DOCKER_IMAGE = 'actualbudget/actual-server:latest';
  const APP_ID = 'actualbudget';
  const CONTAINER_PORT = 5006;
    ...
    setup() {
      ...
      async function pullImage() {
        ...
        try {
          ...
          pullProgress.value = 'Image indirildi! Actual Budget başlatılıyor...';
          await checkAndStart();
        } catch (e) {
