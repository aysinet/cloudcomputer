(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      searchPlaceholder:'Coin ara... (BTCUSDT)',
      ...
      editTooltip:'Düzenle',
      deleteTooltip:'Sil',
      alertTooltip:'Bildirim',
      alertTitle:'Fiyat Bildirimi',
      alertMin:'Minimum Fiyat',
      alertMax:'Maksimum Fiyat',
      alertSave:'Kaydet',
      alertRemove:'Kaldır',
      alertClose:'Kapat',
      alertActive:'Aktif Bildirimler',
      alertNone:'Bildirim yok'
    },
    en: {
      title:'Coin Tracker',
      tabAll:'All',
      ...
      searchPlaceholder:'Search coin... (BTCUSDT)',
    ...
    de: {
      ...
      tabFav:'Favoriten',
      tabPortfolio:'Portfolio',
      searchPlaceholder:'Coin suchen... (BTCUSDT)',
      ...
      addTitle:'Coin hinzufügen',
      lblSymbol:'Symbol',
      lblAmount:'Menge',
      lblBuyPrice:'Kaufpreis (USDT)',
      btnSave:'Speichern',
      btnAdd:'Hinzufügen',
      btnCancel:'Abbrechen',
      ...
      alertTooltip:'Alarm',
      alertTitle:'Preisalarm',
      alertMin:'Mindestpreis',
      alertMax:'Höchstpreis',
      alertSave:'Speichern',
      alertRemove:'Entfernen',
      alertClose:'Schließen',
      alertActive:'Aktive Alarme',
      alertNone:'Keine Alarme'
    },
    fr: {
      title:'Coin Tracker',
      tabAll:'Tous',
      ...
      searchPlaceholder:'Rechercher... (BTCUSDT)',
      ...
      loading:'Chargement...',
      editTitle:'Modifier',
      addTitle:'Ajouter un coin',
      lblSymbol:'Symbole',
      lblAmount:'Montant',
      lblBuyPrice:'Prix d\'achat (USDT)',
      btnSave:'Enregistrer',
      btnAdd:'Ajouter',
      btnCancel:'Annuler',
      ...
      alertTooltip:'Alerte',
      alertTitle:'Alerte de prix',
      alertMin:'Prix minimum',
      alertMax:'Prix maximum',
      alertSave:'Enregistrer',
      alertRemove:'Supprimer',
      alertClose:'Fermer',
      alertActive:'Alertes actives',
    ...
    es: {
      ...
      searchPlaceholder:'Buscar moneda... (BTCUSDT)',
      showHidden:'Mostrar ocultos',
      live:'En vivo',
      disconnected:'Desconectado',
      lastUpdate:'Última',
      colSymbol:'Símbolo',
      colPrice:'Precio (USDT)',
      colActions:'Acciones',
      noResult:'Sin resultados',
      loading:'Cargando datos...',
      editTitle:'Editar',
      addTitle:'Agregar moneda',
      lblSymbol:'Símbolo',
      lblAmount:'Cantidad',
      lblBuyPrice:'Precio de compra (USDT)',
      btnSave:'Guardar',
      btnAdd:'Agregar',
      btnCancel:'Cancelar',
      ...
      alertMin:'Precio mínimo',
      alertMax:'Precio máximo',
      alertSave:'Guardar',
      alertRemove:'Eliminar',
      alertClose:'Cerrar',
      alertActive:'Alertas activas',
      alertNone:'Sin alertas'
    },
    ru: {
      title:'Coin Tracker',
      tabAll:'Все',
      ...
      searchPlaceholder:'Поиск монеты... (BTCUSDT)',
      ...
      addTitle:'Добавить монету',
      lblSymbol:'Символ',
      lblAmount:'Количество',
      lblBuyPrice:'Цена покупки (USDT)',
      btnSave:'Сохранить',
      btnAdd:'Добавить',
      btnCancel:'Отмена',
      ...
      alertTooltip:'Уведомление',
      alertTitle:'Уведомление о цене',
      alertMin:'Мин. цена',
      alertMax:'Макс. цена',
      alertSave:'Сохранить',
      alertRemove:'Удалить',
      alertClose:'Закрыть',
      alertActive:'Активные уведомления',
      alertNone:'Нет уведомлений'
    },
    zh: {
      title:'加密货币追踪',
      tabAll:'全部',
    ...
    ja: {
      ...
      alertRemove:'削除',
      alertClose:'閉じる',
      alertActive:'アクティブなアラート',
      alertNone:'アラートなし'
    },
    it: {
      title:'Tracker Criptovalute',
      tabAll:'Tutte',
      tabFav:'Preferite',
      tabPortfolio:'Portafoglio',
      searchPlaceholder:'Cerca moneta...',
      ...
      alertTooltip:'Avviso',
      alertTitle:'Avviso prezzo',
      alertMin:'Prezzo minimo',
      alertMax:'Prezzo massimo',
      alertSave:'Salva',
      alertRemove:'Rimuovi',
      alertClose:'Chiudi',
      alertActive:'Avvisi attivi',
      alertNone:'Nessun avviso'
    },
    ar: {
      title:'متتبع العملات',
      tabAll:'الكل',
