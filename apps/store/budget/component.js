(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      add:'Ekle',
      addEntry:'Kayıt Ekle',
      editEntry:'Kayıt Düzenle',
      addCat:'Kategori Ekle',
      editCat:'Kategori Düzenle',
      type:'Tür',
      amount:'Tutar',
      category:'Kategori',
      ...
      rec_monthly:'Aylık',
      rec_yearly:'Yıllık',
      selectCat:'Kategori seç',
      descPlaceholder:'Açıklama girin...',
      ...
      cancel:'İptal',
      today:'Bugün',
      noEntries:'Bu ay için kayıt yok',
      saved:'Kaydedildi',
      error:'Hata',
      deleted:'Silindi',
      incomeVsExpense:'Gelir & Gider',
      expenseByCat:'Gider Dağılımı',
      paidVsPending:'Ödenen & Bekleyen',
      paidAmt:'Ödenen',
      unpaidAmt:'Bekleyen',
      notifyMe:'Bildirim gönder',
      showOnCalendar:'Takvimde göster'
    },
    en: {
      income:'Income',
      expense:'Expense',
      ...
      expenseByCat:'Expense Breakdown',
    ...
    de: {
      ...
      descPlaceholder:'Beschreibung eingeben...',
      ...
      cancel:'Abbrechen',
      today:'Heute',
      noEntries:'Keine Einträge für diesen Monat',
      saved:'Gespeichert',
      error:'Fehler',
      deleted:'Gelöscht',
      incomeVsExpense:'Einnahmen & Ausgaben',
      expenseByCat:'Ausgabenverteilung',
      paidVsPending:'Bezahlt & Ausstehend',
      paidAmt:'Bezahlt',
      unpaidAmt:'Ausstehend',
    ...
    fr: {
      ...
      addCat:'Ajouter catégorie',
      editCat:'Modifier catégorie',
      type:'Type',
      amount:'Montant',
      category:'Catégorie',
      description:'Description',
      ...
      rec_monthly:'Mensuel',
      rec_yearly:'Annuel',
      selectCat:'Sélectionner catégorie',
      descPlaceholder:'Entrez une description...',
      ...
      cancel:'Annuler',
      today:'Aujourd\'hui',
      noEntries:'Aucune entrée pour ce mois',
      saved:'Enregistré',
      error:'Erreur',
      deleted:'Supprimé',
      incomeVsExpense:'Revenus & Dépenses',
      expenseByCat:'Répartition des dépenses',
      paidVsPending:'Payé & En attente',
      paidAmt:'Payé',
      unpaidAmt:'En attente',
      notifyMe:'Envoyer une notification',
      showOnCalendar:'Afficher dans le calendrier'
    },
    es: {
      income:'Ingresos',
      expense:'Gastos',
      ...
      descPlaceholder:'Ingrese descripción...',
      ...
      error:'Error',
      deleted:'Eliminado',
      incomeVsExpense:'Ingresos & Gastos',
      expenseByCat:'Desglose de gastos',
      paidVsPending:'Pagado & Pendiente',
      paidAmt:'Pagado',
      unpaidAmt:'Pendiente',
      notifyMe:'Enviar notificación',
    ...
    ru: {
      ...
      rec_yearly:'Ежегодно',
      selectCat:'Выбрать категорию',
      descPlaceholder:'Введите описание...',
      ...
      error:'Ошибка',
      deleted:'Удалено',
      incomeVsExpense:'Доходы & Расходы',
      expenseByCat:'Расходы по категориям',
      paidVsPending:'Оплачено & Ожидает',
      paidAmt:'Оплачено',
      unpaidAmt:'Ожидает',
      notifyMe:'Отправить уведомление',
      showOnCalendar:'Показать в календаре'
    },
    zh: {
      income:'收入',
      expense:'支出',
      ...
      error:'错误',
      deleted:'已删除',
      incomeVsExpense:'收入 & 支出',
      expenseByCat:'支出分类',
      paidVsPending:'已付 & 待付',
      paidAmt:'已付',
      unpaidAmt:'待付',
      notifyMe:'发送通知',
      showOnCalendar:'在日历中显示'
    },
    ja: {
      income:'収入',
      expense:'支出',
      ...
      error:'エラー',
      deleted:'削除しました',
      incomeVsExpense:'収入 & 支出',
      expenseByCat:'支出内訳',
      paidVsPending:'支払済 & 未払い',
      paidAmt:'支払済',
      unpaidAmt:'未払い',
      notifyMe:'通知を送信',
      showOnCalendar:'カレンダーに表示'
    },
    it: {
      income:'Entrate',
      expense:'Uscite',
      ...
      descPlaceholder:'Inserisci descrizione...',
      ...
      cancel:'Annulla',
      today:'Oggi',
      noEntries:'Nessuna voce per questo mese',
      saved:'Salvato',
      error:'Errore',
      deleted:'Eliminato',
      incomeVsExpense:'Entrate & Uscite',
      expenseByCat:'Ripartizione uscite',
      paidVsPending:'Pagato & In sospeso',
      paidAmt:'Pagato',
      unpaidAmt:'In sospeso',
      notifyMe:'Invia notifica',
