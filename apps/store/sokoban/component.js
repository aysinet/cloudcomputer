(function(Vue) {
  ...
  const LANGS = {
    tr: {
      title:'Sokoban', level:'Bölüm', moves:'Hamle', pushes:'İtme',
      restart:'Yeniden Başlat', undo:'Geri Al', prev:'Önceki', next:'Sonraki',
      selectLevel:'Bölüm Seç', completed:'Tebrikler! Bölüm tamamlandı!',
      allCompleted:'Tüm bölümleri tamamladınız! 🎉',
      nextLevel:'Sonraki Bölüm', best:'En İyi', na:'-',
      controls:'Kontroller', arrowKeys:'Ok tuşları veya WASD ile hareket',
      undoKey:'Z: Geri al', restartKey:'R: Yeniden başlat'
    },
    en: {
      title:'Sokoban', level:'Level', moves:'Moves', pushes:'Pushes',
      restart:'Restart', undo:'Undo', prev:'Previous', next:'Next',
      selectLevel:'Select Level', completed:'Congratulations! Level completed!',
      allCompleted:'You completed all levels! 🎉',
      nextLevel:'Next Level', best:'Best', na:'-',
      controls:'Controls', arrowKeys:'Arrow keys or WASD to move',
      undoKey:'Z: Undo', restartKey:'R: Restart'
    },
    de: {
      title:'Sokoban', level:'Level', moves:'Züge', pushes:'Schübe',
      restart:'Neustart', undo:'Rückgängig', prev:'Vorheriges', next:'Nächstes',
      selectLevel:'Level wählen', completed:'Gratulation! Level geschafft!',
      allCompleted:'Alle Level geschafft! 🎉',
      nextLevel:'Nächstes Level', best:'Bestzeit', na:'-',
      controls:'Steuerung', arrowKeys:'Pfeiltasten oder WASD',
      undoKey:'Z: Rückgängig', restartKey:'R: Neustart'
    },
    fr: {
      title:'Sokoban', level:'Niveau', moves:'Mouvements', pushes:'Poussées',
      restart:'Recommencer', undo:'Annuler', prev:'Précédent', next:'Suivant',
      selectLevel:'Choisir niveau', completed:'Félicitations ! Niveau terminé !',
      allCompleted:'Tous les niveaux terminés ! 🎉',
      nextLevel:'Niveau suivant', best:'Meilleur', na:'-',
      controls:'Contrôles', arrowKeys:'Flèches ou WASD pour se déplacer',
      undoKey:'Z: Annuler', restartKey:'R: Recommencer'
    },
    es: {
      title:'Sokoban', level:'Nivel', moves:'Movimientos', pushes:'Empujes',
      restart:'Reiniciar', undo:'Deshacer', prev:'Anterior', next:'Siguiente',
      selectLevel:'Elegir nivel', completed:'¡Felicidades! ¡Nivel completado!',
      allCompleted:'¡Completaste todos los niveles! 🎉',
      nextLevel:'Siguiente nivel', best:'Mejor', na:'-',
      controls:'Controles', arrowKeys:'Flechas o WASD para mover',
      undoKey:'Z: Deshacer', restartKey:'R: Reiniciar'
    },
    ru: {
      title:'Сокобан', level:'Уровень', moves:'Ходы', pushes:'Толчки',
      restart:'Заново', undo:'Отмена', prev:'Предыдущий', next:'Следующий',
      selectLevel:'Выбрать уровень', completed:'Поздравляем! Уровень пройден!',
