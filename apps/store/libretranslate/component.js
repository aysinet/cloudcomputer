(function(Vue) {
  ...
  const LANGS = {
    tr: {
      title: 'LibreTranslate', pulling: 'Docker image indiriliyor',
      pullingNote: 'İlk kurulumda dil modelleri indirilir, bu biraz sürebilir...',
      starting: 'LibreTranslate başlatılıyor...', startingNote: 'Dil modelleri yükleniyor',
      errorTitle: 'Bir hata oluştu', retry: 'Tekrar Dene',
      errorNote: "Docker'ın yüklü ve çalışır durumda olduğundan emin olun.",
      startBtn: 'Başlat', subtitle: 'Açık kaynak makine çevirisi',
      restart: 'Yeniden Başlat', stop: 'Durdur',
      sourceLang: 'Kaynak Dil', targetLang: 'Hedef Dil',
      inputPlaceholder: 'Çevrilecek metni yazın...', translateBtn: 'Çevir',
      translating: 'Çevriliyor...', swap: 'Değiştir',
      autoDetect: 'Otomatik Algıla', copyBtn: 'Kopyala', copied: 'Kopyalandı!',
      clearBtn: 'Temizle', charCount: 'karakter',
      loadingLangs: 'Diller yükleniyor...', apiReady: 'API Hazır',
      apiWaiting: 'API Bekleniyor'
    },
    en: {
      title: 'LibreTranslate', pulling: 'Downloading Docker image',
      pullingNote: 'Language models are downloaded on first setup, this may take a while...',
      starting: 'Starting LibreTranslate...', startingNote: 'Loading language models',
      errorTitle: 'An error occurred', retry: 'Retry',
      errorNote: 'Make sure Docker is installed and running.',
      startBtn: 'Start', subtitle: 'Open source machine translation',
      restart: 'Restart', stop: 'Stop',
      sourceLang: 'Source Language', targetLang: 'Target Language',
      inputPlaceholder: 'Enter text to translate...', translateBtn: 'Translate',
      translating: 'Translating...', swap: 'Swap',
      autoDetect: 'Auto Detect', copyBtn: 'Copy', copied: 'Copied!',
      clearBtn: 'Clear', charCount: 'characters',
      loadingLangs: 'Loading languages...', apiReady: 'API Ready',
      apiWaiting: 'Waiting for API'
    },
    de: {
      title: 'LibreTranslate', pulling: 'Docker-Image wird heruntergeladen',
      pullingNote: 'Sprachmodelle werden beim ersten Start heruntergeladen...',
      starting: 'LibreTranslate wird gestartet...', startingNote: 'Sprachmodelle werden geladen',
      errorTitle: 'Ein Fehler ist aufgetreten', retry: 'Erneut versuchen',
      errorNote: 'Stellen Sie sicher, dass Docker installiert ist und läuft.',
      startBtn: 'Starten', subtitle: 'Open-Source-Maschinenübersetzung',
      restart: 'Neustart', stop: 'Stoppen',
      sourceLang: 'Ausgangssprache', targetLang: 'Zielsprache',
      inputPlaceholder: 'Text zum Übersetzen eingeben...', translateBtn: 'Übersetzen',
      translating: 'Übersetze...', swap: 'Tauschen',
      autoDetect: 'Automatisch erkennen', copyBtn: 'Kopieren', copied: 'Kopiert!',
      clearBtn: 'Löschen', charCount: 'Zeichen',
      loadingLangs: 'Sprachen werden geladen...', apiReady: 'API bereit',
      apiWaiting: 'Warte auf API'
    },
    fr: {
      title: 'LibreTranslate', pulling: "Téléchargement de l'image Docker",
      pullingNote: 'Les modèles linguistiques sont téléchargés au premier démarrage...',
      starting: 'Démarrage de LibreTranslate...', startingNote: 'Chargement des modèles',
      errorTitle: 'Une erreur est survenue', retry: 'Réessayer',
      errorNote: "Assurez-vous que Docker est installé et en cours d'exécution.",
      startBtn: 'Démarrer', subtitle: 'Traduction automatique open source',
      restart: 'Redémarrer', stop: 'Arrêter',
      sourceLang: 'Langue source', targetLang: 'Langue cible',
      inputPlaceholder: 'Entrez le texte à traduire...', translateBtn: 'Traduire',
      translating: 'Traduction...', swap: 'Inverser',
      autoDetect: 'Détection auto', copyBtn: 'Copier', copied: 'Copié !',
      clearBtn: 'Effacer', charCount: 'caractères',
      loadingLangs: 'Chargement des langues...', apiReady: 'API prête',
      apiWaiting: "En attente de l'API"
    },
    es: {
      title: 'LibreTranslate', pulling: 'Descargando imagen Docker',
      pullingNote: 'Los modelos de idioma se descargan en la primera configuración...',
      starting: 'Iniciando LibreTranslate...', startingNote: 'Cargando modelos de idioma',
      errorTitle: 'Ocurrió un error', retry: 'Reintentar',
      errorNote: 'Asegúrese de que Docker esté instalado y en ejecución.',
      startBtn: 'Iniciar', subtitle: 'Traducción automática de código abierto',
      restart: 'Reiniciar', stop: 'Detener',
      sourceLang: 'Idioma origen', targetLang: 'Idioma destino',
      inputPlaceholder: 'Ingrese texto para traducir...', translateBtn: 'Traducir',
      translating: 'Traduciendo...', swap: 'Intercambiar',
      autoDetect: 'Detección automática', copyBtn: 'Copiar', copied: '¡Copiado!',
      clearBtn: 'Limpiar', charCount: 'caracteres',
      loadingLangs: 'Cargando idiomas...', apiReady: 'API lista',
      apiWaiting: 'Esperando API'
    },
    ru: {
      title: 'LibreTranslate', pulling: 'Загрузка Docker-образа',
      pullingNote: 'Языковые модели загружаются при первой установке...',
      starting: 'Запуск LibreTranslate...', startingNote: 'Загрузка языковых моделей',
      errorTitle: 'Произошла ошибка', retry: 'Повторить',
      errorNote: 'Убедитесь, что Docker установлен и работает.',
      startBtn: 'Запустить', subtitle: 'Машинный перевод с открытым кодом',
      restart: 'Перезапустить', stop: 'Остановить',
      sourceLang: 'Исходный язык', targetLang: 'Целевой язык',
      inputPlaceholder: 'Введите текст для перевода...', translateBtn: 'Перевести',
      translating: 'Перевод...', swap: 'Поменять',
      autoDetect: 'Автоопределение', copyBtn: 'Копировать', copied: 'Скопировано!',
      clearBtn: 'Очистить', charCount: 'символов',
