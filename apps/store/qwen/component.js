(function(Vue) {
  ...
  return {
    setup() {
      ...
      const iframeSrc = ref(proxyUrl('https://chat.qwen.ai/'));

      function navigateHome() {
        iframeSrc.value = proxyUrl('https://chat.qwen.ai/');
      }

      function goBack() {
        try {
          if (qwenFrame.value) qwenFrame.value.contentWindow.history.back();
        } catch(e) {}
      }

      function goForward() {
        try {
          if (qwenFrame.value) qwenFrame.value.contentWindow.history.forward();
        } catch(e) {}
      }
