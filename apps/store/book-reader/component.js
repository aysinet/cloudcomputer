({
  setup() {
    ...
    zh: { title:'电子书阅读器', open:'打开文件', upload:'上传', library:'书库', toc:'目录', bookmarks:'书签', settings:'设置', addBookmark:'添加书签', removeBookmark:'移除书签', goTo:'前往', fontSize:'字体大小', theme:'主题', light:'浅色', dark:'深色', sepia:'护眼', lineHeight:'行高', fontFamily:'字体', margins:'边距', prevPage:'上一页', nextPage:'下一页', page:'页', of:'/', noBook:'未打开书籍', dropHere:'拖放文件到此处', supported:'支持的格式', progress:'进度', noToc:'无目录', noBookmarks:'无书签', deleteConfirm:'确认删除？', yes:'是', cancel:'取消', delete:'删除', loading:'加载中', loadError:'加载失败', bookmarkAdded:'书签已添加', fullscreen:'全屏', exitFullscreen:'退出全屏', openFromServer:'从服务器打开', searchPlaceholder:'搜索...', zoomIn:'放大', zoomOut:'缩小', fitWidth:'适应宽度', continuous:'连续模式', paginated:'分页模式', viewMode:'查看模式', saveProgress:'保存进度', lastRead:'上次阅读', removeFromLib:'从书库移除', noLibBooks:'书库为空', bookmarkLabel:'书签名称', bookmarkPlaceholder:'输入书签名称' },
    ja: { title:'電子書籍リーダー', open:'ファイルを開く', upload:'アップロード', library:'ライブラリ', toc:'目次', bookmarks:'ブックマーク', settings:'設定', addBookmark:'ブックマーク追加', removeBookmark:'ブックマーク削除', goTo:'移動', fontSize:'文字サイズ', theme:'テーマ', light:'ライト', dark:'ダーク', sepia:'セピア', lineHeight:'行間', fontFamily:'フォント', margins:'余白', prevPage:'前のページ', nextPage:'次のページ', page:'ページ', of:'/', noBook:'書籍が開かれていません', dropHere:'ここにファイルをドロップ', supported:'対応形式', progress:'進捗', noToc:'目次なし', noBookmarks:'ブックマークなし', deleteConfirm:'削除しますか？', yes:'はい', cancel:'キャンセル', delete:'削除', loading:'読込中', loadError:'読込エラー', bookmarkAdded:'ブックマーク追加済', fullscreen:'全画面', exitFullscreen:'全画面終了', openFromServer:'サーバーから開く', searchPlaceholder:'検索...', zoomIn:'拡大', zoomOut:'縮小', fitWidth:'幅に合わせる', continuous:'連続表示', paginated:'ページ表示', viewMode:'表示モード', saveProgress:'進捗保存', lastRead:'最後に読んだ', removeFromLib:'ライブラリから削除', noLibBooks:'ライブラリは空です', bookmarkLabel:'ブックマーク名', bookmarkPlaceholder:'ブックマーク名を入力' },
    it: { title:'Lettore eBook', open:'Apri file', upload:'Carica', library:'Libreria', toc:'Indice', bookmarks:'Segnalibri', settings:'Impostazioni', addBookmark:'Aggiungi segnalibro', removeBookmark:'Rimuovi segnalibro', goTo:'Vai a', fontSize:'Dimensione testo', theme:'Tema', light:'Chiaro', dark:'Scuro', sepia:'Seppia', lineHeight:'Interlinea', fontFamily:'Carattere', margins:'Margini', prevPage:'Pagina precedente', nextPage:'Pagina successiva', page:'Pagina', of:'di', noBook:'Nessun libro aperto', dropHere:'Trascina file qui', supported:'Formati supportati', progress:'Progresso', noToc:'Nessun indice', noBookmarks:'Nessun segnalibro', deleteConfirm:'Confermi eliminazione?', yes:'Sì', cancel:'Annulla', delete:'Elimina', loading:'Caricamento', loadError:'Errore caricamento', bookmarkAdded:'Segnalibro aggiunto', fullscreen:'Schermo intero', exitFullscreen:'Esci da schermo intero', openFromServer:'Apri dal server', searchPlaceholder:'Cerca...', zoomIn:'Ingrandisci', zoomOut:'Riduci', fitWidth:'Adatta larghezza', continuous:'Continuo', paginated:'Paginato', viewMode:'Modalità vista', saveProgress:'Salva progresso', lastRead:'Ultima lettura', removeFromLib:'Rimuovi dalla libreria', noLibBooks:'Libreria vuota', bookmarkLabel:'Nome segnalibro', bookmarkPlaceholder:'Inserisci nome segnalibro' }
  };
