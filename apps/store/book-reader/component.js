  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        page:'Sayfa',
        of:'/',
        noBook:'Henüz kitap açılmadı',
        dropHere:'veya sürükle bırak',
        supported:'Desteklenen formatlar',
        progress:'İlerleme',
        noToc:'İçindekiler tablosu bulunamadı',
        ...
        paginated:'Sayfalı',
        viewMode:'Görünüm',
        saveProgress:'İlerleme kaydedildi',
        lastRead:'Son okunan',
        removeFromLib:'Kütüphaneden Kaldır',
        noLibBooks:'Kütüphane boş',
        bookmarkLabel:'Yer İmi Adı',
        bookmarkPlaceholder:'Yer imi açıklaması...'
      },
      en: {
        title:'Book Reader',
        open:'Open File',
        ...
        noLibBooks:'Library is empty',
        bookmarkLabel:'Bookmark Label',
        bookmarkPlaceholder:'Bookmark description...'
      },
      de: {
        title:'Buchleser',
        open:'Datei öffnen',
        ...
        page:'Seite',
        of:'/',
        noBook:'Noch kein Buch geöffnet',
        dropHere:'oder per Drag & Drop',
        supported:'Unterstützte Formate',
        progress:'Fortschritt',
        noToc:'Kein Inhaltsverzeichnis gefunden',
        ...
        openFromServer:'Vom Server öffnen',
        ...
        removeFromLib:'Aus Bibliothek entfernen',
        noLibBooks:'Bibliothek ist leer',
        bookmarkLabel:'Lesezeichen-Name',
        bookmarkPlaceholder:'Lesezeichen-Beschreibung...'
      },
      fr: {
        ...
        page:'Page',
        of:'/',
        noBook:'Aucun livre ouvert',
        dropHere:'ou glisser-déposer',
        supported:'Formats supportés',
        progress:'Progression',
        noToc:'Aucune table des matières trouvée',
        ...
        saveProgress:'Progression sauvegardée',
        lastRead:'Dernière lecture',
        removeFromLib:'Retirer de la bibliothèque',
        noLibBooks:'Bibliothèque vide',
        bookmarkLabel:'Nom du signet',
        bookmarkPlaceholder:'Description du signet...'
      },
      es: {
        ...
        page:'Página',
        of:'/',
        noBook:'Ningún libro abierto',
        dropHere:'o arrastrar y soltar',
        supported:'Formatos soportados',
        progress:'Progreso',
        noToc:'No se encontró índice',
        ...
        removeFromLib:'Eliminar de la biblioteca',
        noLibBooks:'Biblioteca vacía',
        bookmarkLabel:'Nombre del marcador',
        bookmarkPlaceholder:'Descripción del marcador...'
      },
      ru: {
        title:'Читалка',
        open:'Открыть файл',
        ...
        page:'Страница',
        of:'/',
        noBook:'Книга не открыта',
        dropHere:'или перетащите файл',
        supported:'Поддерживаемые форматы',
        progress:'Прогресс',
        noToc:'Содержание не найдено',
        ...
        viewMode:'Вид',
        saveProgress:'Прогресс сохранён',
        lastRead:'Последнее чтение',
        removeFromLib:'Удалить из библиотеки',
        noLibBooks:'Библиотека пуста',
        bookmarkLabel:'Название закладки',
        bookmarkPlaceholder:'Описание закладки...'
      },
      zh: {
        title:'电子书阅读器',
        open:'打开文件',
      ...
      ja: {
        ...
        loading:'読込中',
        loadError:'読込エラー',
        bookmarkAdded:'ブックマーク追加済',
        fullscreen:'全画面',
        exitFullscreen:'全画面終了',
        openFromServer:'サーバーから開く',
        ...
        saveProgress:'進捗保存',
        lastRead:'最後に読んだ',
        removeFromLib:'ライブラリから削除',
        noLibBooks:'ライブラリは空です',
        bookmarkLabel:'ブックマーク名',
        bookmarkPlaceholder:'ブックマーク名を入力'
      },
      it: {
        title:'Lettore eBook',
        open:'Apri file',
        ...
        removeFromLib:'Rimuovi dalla libreria',
        noLibBooks:'Libreria vuota',
        bookmarkLabel:'Nome segnalibro',
        bookmarkPlaceholder:'Inserisci nome segnalibro'
      },
      ar: {
        title:'قارئ الكتب',
        open:'فتح ملف',
