({
  setup() {
    ...
    const LANGS = {
      tr: {
        title:'Arşivleyici', tabCompress:'Sıkıştır', tabExtract:'Aç',
        format:'Format', selectFiles:'Dosya / Klasör Seç', selectArchive:'Arşiv Dosyası Seç',
        compress:'Sıkıştır', extract:'Çıkart', archiveName:'Arşiv Adı',
        extractTo:'Çıkart Hedefi', archiveContents:'Arşiv İçeriği',
        emptyDir:'Klasör boş', itemsSelected:'öğe seçili',
        gzipHint:'GZIP yalnızca tek dosya sıkıştırır',
        compressing:'Sıkıştırılıyor...', extracting:'Çıkartılıyor...',
        success:'Başarılı', error:'Hata',
        compressDone:'Arşiv oluşturuldu', extractDone:'Çıkartma tamamlandı',
        noSelection:'Lütfen dosya seçin', noArchive:'Lütfen bir arşiv dosyası seçin',
        invalidFormat:'Desteklenmeyen dosya formatı'
      },
      en: {
        title:'Archiver', tabCompress:'Compress', tabExtract:'Extract',
        format:'Format', selectFiles:'Select Files / Folders', selectArchive:'Select Archive',
        compress:'Compress', extract:'Extract', archiveName:'Archive Name',
        extractTo:'Extract To', archiveContents:'Archive Contents',
        emptyDir:'Folder is empty', itemsSelected:'items selected',
        gzipHint:'GZIP compresses a single file only',
        compressing:'Compressing...', extracting:'Extracting...',
        success:'Success', error:'Error',
        compressDone:'Archive created', extractDone:'Extraction completed',
        noSelection:'Please select files', noArchive:'Please select an archive file',
        invalidFormat:'Unsupported file format'
      },
      de: {
        title:'Archivierer', tabCompress:'Komprimieren', tabExtract:'Entpacken',
        format:'Format', selectFiles:'Dateien / Ordner wählen', selectArchive:'Archivdatei wählen',
        compress:'Komprimieren', extract:'Entpacken', archiveName:'Archivname',
        extractTo:'Entpacken nach', archiveContents:'Archivinhalt',
        emptyDir:'Ordner ist leer', itemsSelected:'Elemente ausgewählt',
        gzipHint:'GZIP komprimiert nur eine einzelne Datei',
        compressing:'Komprimierung...', extracting:'Entpacken...',
        success:'Erfolgreich', error:'Fehler',
        compressDone:'Archiv erstellt', extractDone:'Entpacken abgeschlossen',
        noSelection:'Bitte Dateien wählen', noArchive:'Bitte eine Archivdatei wählen',
        invalidFormat:'Nicht unterstütztes Dateiformat'
      },
      fr: {
        title:'Archiveur', tabCompress:'Compresser', tabExtract:'Extraire',
        format:'Format', selectFiles:'Sélectionner des fichiers', selectArchive:'Sélectionner une archive',
        compress:'Compresser', extract:'Extraire', archiveName:'Nom de l\'archive',
        extractTo:'Extraire vers', archiveContents:'Contenu de l\'archive',
        emptyDir:'Dossier vide', itemsSelected:'éléments sélectionnés',
        gzipHint:'GZIP ne compresse qu\'un seul fichier',
        compressing:'Compression...', extracting:'Extraction...',
        success:'Succès', error:'Erreur',
        compressDone:'Archive créée', extractDone:'Extraction terminée',
        noSelection:'Veuillez sélectionner des fichiers', noArchive:'Veuillez sélectionner une archive',
        invalidFormat:'Format de fichier non pris en charge'
      },
      es: {
        title:'Archivador', tabCompress:'Comprimir', tabExtract:'Extraer',
        format:'Formato', selectFiles:'Seleccionar archivos', selectArchive:'Seleccionar archivo',
        compress:'Comprimir', extract:'Extraer', archiveName:'Nombre del archivo',
        extractTo:'Extraer en', archiveContents:'Contenido del archivo',
        emptyDir:'Carpeta vacía', itemsSelected:'elementos seleccionados',
        gzipHint:'GZIP solo comprime un archivo',
        compressing:'Comprimiendo...', extracting:'Extrayendo...',
        success:'Éxito', error:'Error',
        compressDone:'Archivo creado', extractDone:'Extracción completada',
        noSelection:'Seleccione archivos', noArchive:'Seleccione un archivo',
        invalidFormat:'Formato de archivo no compatible'
      },
      ru: {
        title:'Архиватор', tabCompress:'Сжать', tabExtract:'Извлечь',
        format:'Формат', selectFiles:'Выберите файлы', selectArchive:'Выберите архив',
        compress:'Сжать', extract:'Извлечь', archiveName:'Имя архива',
        extractTo:'Извлечь в', archiveContents:'Содержимое архива',
        emptyDir:'Папка пуста', itemsSelected:'элементов выбрано',
        gzipHint:'GZIP сжимает только один файл',
        compressing:'Сжатие...', extracting:'Извлечение...',
