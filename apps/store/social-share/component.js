(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      image:'Görsel',
      message:'Mesaj',
      messagePlaceholder:'Paylaşmak istediğiniz mesajı yazın...',
      url:'Bağlantı',
      urlPlaceholder:'https://ornek.com/sayfa',
      pickImage:'Dosyadan Seç',
      imageUrlPlaceholder:'Görsel URL\'si yapıştır...',
      hashtags:'Etiketler',
      addHashtag:'Etiket ekle...',
      ...
      incomingContent:'Başka uygulamadan içerik alındı',
    ...
    en: {
      ...
      image:'Image',
      message:'Message',
      messagePlaceholder:'Write the message you want to share...',
      url:'Link',
      urlPlaceholder:'https://example.com/page',
      pickImage:'Pick from Files',
      ...
      incomingContent:'Content received from another app',
    ...
    de: {
      ...
      image:'Bild',
      message:'Nachricht',
      messagePlaceholder:'Schreiben Sie die Nachricht, die Sie teilen möchten...',
      url:'Link',
      urlPlaceholder:'https://beispiel.de/seite',
      pickImage:'Aus Dateien wählen',
      ...
      incomingContent:'Inhalt von einer anderen App empfangen',
    ...
    fr: {
      ...
      image:'Image',
      message:'Message',
      messagePlaceholder:'Écrivez le message que vous souhaitez partager...',
      url:'Lien',
      urlPlaceholder:'https://exemple.fr/page',
      pickImage:'Choisir un fichier',
      ...
      incomingContent:'Contenu reçu d\'une autre application',
    ...
    es: {
      ...
      image:'Imagen',
      message:'Mensaje',
      messagePlaceholder:'Escriba el mensaje que desea compartir...',
      url:'Enlace',
      urlPlaceholder:'https://ejemplo.com/pagina',
      pickImage:'Elegir archivo',
      imageUrlPlaceholder:'Pegar URL de imagen...',
      hashtags:'Hashtags',
      ...
      reshare:'Recompartir',
      shared:'¡Compartido!',
      selectPlatform:'Seleccione al menos una plataforma',
      enterMessage:'Ingrese un mensaje',
      incomingContent:'Contenido recibido de otra aplicación',
    ...
    ru: {
      ...
      image:'Изображение',
      message:'Сообщение',
      messagePlaceholder:'Напишите сообщение для публикации...',
      url:'Ссылка',
      urlPlaceholder:'https://пример.com/страница',
      pickImage:'Выбрать файл',
      ...
      delete:'Удалить',
      reshare:'Поделиться снова',
      shared:'Опубликовано!',
      selectPlatform:'Выберите хотя бы одну платформу',
      enterMessage:'Введите сообщение',
      incomingContent:'Контент получен из другого приложения',
    ...
    ja: {
      ...
      enterMessage:'メッセージ入力',
      incomingContent:'受信コンテンツ',
    ...
    it: {
      ...
      image:'Immagine',
      message:'Messaggio',
      messagePlaceholder:'Inserisci messaggio...',
      url:'URL',
      urlPlaceholder:'Inserisci URL...',
      https:'https://',
      pickImage:'Scegli immagine',
      imageUrlPlaceholder:'Inserisci URL immagine...',
      hashtags:'Hashtag',
      ...
      incomingContent:'Contenuto in arrivo',
