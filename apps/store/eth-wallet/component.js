  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        lock:'Kilitle',
        create:'Yeni Cüzdan',
        import:'Cüzdan İçe Aktar',
        password:'Şifre',
        confirmPassword:'Şifre Tekrar',
        walletPassword:'Cüzdan Şifresi',
        enterPassword:'Cüzdan şifrenizi girin',
        setPassword:'Yeni şifre belirleyin',
        wrongPassword:'Yanlış şifre',
        passwordMismatch:'Şifreler eşleşmiyor',
        passwordMin:'Şifre en az 6 karakter',
        mnemonic:'Kurtarma Kelimeleri',
        mnemonicWarning:'Bu kelimeleri güvenli bir yere kaydedin! Bir daha gösterilmeyecek.',
        mnemonicPlaceholder:'12 kelimelik kurtarma ifadesini girin',
        enterMnemonic:'Kurtarma kelimelerini girin',
        invalidMnemonic:'Geçersiz kurtarma kelimeleri',
        copied:'Kopyalandı',
        copy:'Kopyala',
        balance:'Bakiye',
        send:'Gönder',
        ...
        txSuccess:'İşlem gönderildi',
        txError:'İşlem hatası',
        noTx:'Henüz işlem yok',
        noNFTs:'NFT bulunamadı',
        ...
        refresh:'Yenile',
        address:'Adres',
        confirmSend:'göndermek istediğinize emin misiniz?',
        ...
        viewPhrase:'Kurtarma Kelimeleri',
        gas:'Gas Ücreti',
        total:'Toplam',
        max:'Maks',
      ...
      en: {
        ...
        mnemonicWarning:'Save these words in a safe place! They will not be shown again.',
        mnemonicPlaceholder:'Enter 12-word recovery phrase',
      ...
      de: {
        ...
        enterPassword:'Geben Sie Ihr Wallet-Passwort ein',
        setPassword:'Neues Passwort festlegen',
        wrongPassword:'Falsches Passwort',
        passwordMismatch:'Passwörter stimmen nicht überein',
        passwordMin:'Passwort min. 6 Zeichen',
        mnemonic:'Wiederherstellungsphrase',
        mnemonicWarning:'Speichern Sie diese Wörter an einem sicheren Ort!',
        mnemonicPlaceholder:'12-Wort-Wiederherstellungsphrase eingeben',
        enterMnemonic:'Wiederherstellungsphrase eingeben',
        invalidMnemonic:'Ungültige Wiederherstellungsphrase',
        copied:'Kopiert',
        copy:'Kopieren',
        balance:'Guthaben',
        send:'Senden',
        ...
        txSuccess:'Transaktion gesendet',
        ...
        address:'Adresse',
        confirmSend:'Möchten Sie wirklich senden?',
        ...
        viewPhrase:'Wiederherstellungsphrase',
        gas:'Gas-Gebühr',
        total:'Gesamt',
        max:'Max',
      ...
      fr: {
        ...
        mnemonicWarning:'Sauvegardez ces mots dans un endroit sûr !',
        mnemonicPlaceholder:'Entrez la phrase de récupération de 12 mots',
        enterMnemonic:'Entrez la phrase de récupération',
        invalidMnemonic:'Phrase de récupération invalide',
        copied:'Copié',
        copy:'Copier',
        balance:'Solde',
        send:'Envoyer',
        ...
        sendETH:'Envoyer ETH',
        sending:'Envoi...',
        txSuccess:'Transaction envoyée',
        txError:'Erreur de transaction',
        ...
        account:'Compte',
        iSaved:'J\'ai sauvegardé',
        back:'Retour',
        refresh:'Actualiser',
        address:'Adresse',
        confirmSend:'Êtes-vous sûr de vouloir envoyer ?',
        ...
        viewPhrase:'Phrase de récupération',
        gas:'Frais de gas',
        total:'Total',
        max:'Max',
      ...
      es: {
        ...
        setPassword:'Establezca una nueva contraseña',
        wrongPassword:'Contraseña incorrecta',
        passwordMismatch:'Las contraseñas no coinciden',
        passwordMin:'Contraseña mín. 6 caracteres',
        mnemonic:'Frase de Recuperación',
        mnemonicWarning:'Guarde estas palabras en un lugar seguro!',
        mnemonicPlaceholder:'Ingrese la frase de recuperación de 12 palabras',
        enterMnemonic:'Ingrese la frase de recuperación',
        ...
        nfts:'NFTs',
        toAddress:'Dirección del Destinatario',
        amount:'Cantidad',
        sendETH:'Enviar ETH',
        sending:'Enviando...',
        txSuccess:'Transacción enviada',
        ...
        refresh:'Actualizar',
        address:'Dirección',
        confirmSend:'¿Está seguro de que desea enviar?',
        ...
        viewPhrase:'Frase de Recuperación',
        gas:'Tarifa de Gas',
        total:'Total',
        max:'Máx',
      ...
      ru: {
        ...
        enterPassword:'Введите пароль кошелька',
        setPassword:'Установите новый пароль',
        wrongPassword:'Неверный пароль',
        passwordMismatch:'Пароли не совпадают',
        passwordMin:'Пароль мин. 6 символов',
        mnemonic:'Фраза восстановления',
        mnemonicWarning:'Сохраните эти слова в безопасном месте!',
        mnemonicPlaceholder:'Введите 12-словную фразу восстановления',
        enterMnemonic:'Введите фразу восстановления',
        invalidMnemonic:'Недействительная фраза восстановления',
        copied:'Скопировано',
        copy:'Копировать',
        balance:'Баланс',
        send:'Отправить',
        ...
        sending:'Отправка...',
        txSuccess:'Транзакция отправлена',
        ...
        refresh:'Обновить',
        address:'Адрес',
        confirmSend:'Вы уверены, что хотите отправить?',
        ...
        viewPhrase:'Фраза восстановления',
        gas:'Комиссия Gas',
        total:'Всего',
        max:'Макс',
      ...
      zh: {
        ...
        passwordMin:'密码至少',
        mnemonic:'助记词',
        mnemonicWarning:'助记词警告',
        mnemonicPlaceholder:'输入助记词',
        enterMnemonic:'输入助记词',
      ...
      ja: {
        ...
        passwordMin:'パスワード最低',
        mnemonic:'ニーモニック',
        mnemonicWarning:'ニーモニック警告',
        mnemonicPlaceholder:'ニーモニック入力',
        enterMnemonic:'ニーモニック入力',
        ...
        privateKey:'秘密鍵',
        enterPrivateKey:'秘密鍵入力',
        viewPhrase:'フレーズ表示',
        gas:'ガス',
        total:'合計',
        max:'最大',
        checkExplorer:'エクスプローラーで確認'
      },
      it: {
        title:'Portafoglio ETH',
        unlock:'Sblocca',
        lock:'Blocca',
        create:'Crea',
        import:'Importa',
        ...
        passwordMin:'Password minima',
        mnemonic:'Frase mnemonica',
        mnemonicWarning:'Avviso frase mnemonica',
        mnemonicPlaceholder:'Inserisci frase',
        enterMnemonic:'Inserisci frase',
        invalidMnemonic:'Frase non valida',
        copied:'Copiato',
        copy:'Copia',
        balance:'Saldo',
        send:'Invia',
        ...
        viewPhrase:'Mostra frase',
        gas:'Gas',
        total:'Totale',
        max:'Massimo',
        checkExplorer:'Verifica su explorer'
      },
      ar: {
        title:'محفظة ETH',
        unlock:'Unlock',
