({
  setup() {
    ...
    zh: { title:'Torrent', addTorrent:'添加Torrent', magnetLink:'磁力链接', torrentFile:'Torrent文件', add:'添加', cancel:'取消', pause:'暂停', resume:'继续', remove:'移除', removeData:'移除及删除数据', settings:'设置', name:'名称', size:'大小', progress:'进度', status:'状态', downSpeed:'下载速度', upSpeed:'上传速度', peers:'节点', seeds:'做种', eta:'预计剩余时间', ratio:'比率', added:'已添加', all:'全部', downloading:'下载中', seeding:'做种中', completed:'已完成', paused:'已暂停', queued:'排队中', error:'错误', general:'常规', files:'文件', peerList:'节点列表', trackers:'Tracker', info:'信息', noTorrents:'没有Torrent', addMagnet:'添加磁力链接', selectFile:'选择文件', deleteConfirm:'确认删除？', yes:'是', totalDown:'总下载', totalUp:'总上传', downloadPath:'下载路径', maxDown:'最大下载速度', maxUp:'最大上传速度', unlimited:'无限制', save:'保存', port:'端口', dht:'DHT', fileName:'文件名', fileSize:'文件大小', fileProg:'文件进度', peerAddr:'节点地址', peerClient:'客户端', peerDown:'下载速度', peerUp:'上传速度', trackerUrl:'Tracker地址', trackerStatus:'Tracker状态', hash:'哈希值', created:'创建时间', comment:'备注', creator:'创建者', private:'私有', pieces:'分片', pieceLen:'分片大小', magnetPlaceholder:'输入磁力链接...', magnet:'磁力', urn:'URN', btih:'BTIH', or:'或', startAll:'全部开始', pauseAll:'全部暂停', connected:'已连接', disconnected:'已断开', notInstalled:'未安装' },
    ja: { title:'Torrent', addTorrent:'Torrent追加', magnetLink:'マグネットリンク', torrentFile:'Torrentファイル', add:'追加', cancel:'キャンセル', pause:'一時停止', resume:'再開', remove:'削除', removeData:'データも削除', settings:'設定', name:'名前', size:'サイズ', progress:'進捗', status:'状態', downSpeed:'ダウンロード速度', upSpeed:'アップロード速度', peers:'ピア', seeds:'シード', eta:'残り時間', ratio:'レシオ', added:'追加済', all:'すべて', downloading:'ダウンロード中', seeding:'シード中', completed:'完了', paused:'一時停止中', queued:'待機中', error:'エラー', general:'一般', files:'ファイル', peerList:'ピア一覧', trackers:'トラッカー', info:'情報', noTorrents:'Torrentなし', addMagnet:'マグネット追加', selectFile:'ファイル選択', deleteConfirm:'削除しますか？', yes:'はい', totalDown:'総ダウンロード', totalUp:'総アップロード', downloadPath:'ダウンロード先', maxDown:'最大ダウンロード速度', maxUp:'最大アップロード速度', unlimited:'無制限', save:'保存', port:'ポート', dht:'DHT', fileName:'ファイル名', fileSize:'ファイルサイズ', fileProg:'ファイル進捗', peerAddr:'ピアアドレス', peerClient:'クライアント', peerDown:'ダウンロード速度', peerUp:'アップロード速度', trackerUrl:'トラッカーURL', trackerStatus:'トラッカー状態', hash:'ハッシュ', created:'作成日', comment:'コメント', creator:'作成者', private:'プライベート', pieces:'ピース', pieceLen:'ピースサイズ', magnetPlaceholder:'マグネットリンクを入力...', magnet:'マグネット', urn:'URN', btih:'BTIH', or:'または', startAll:'すべて開始', pauseAll:'すべて一時停止', connected:'接続済', disconnected:'切断', notInstalled:'未インストール' },
    it: { title:'Torrent', addTorrent:'Aggiungi Torrent', magnetLink:'Link magnet', torrentFile:'File Torrent', add:'Aggiungi', cancel:'Annulla', pause:'Pausa', resume:'Riprendi', remove:'Rimuovi', removeData:'Rimuovi con dati', settings:'Impostazioni', name:'Nome', size:'Dimensione', progress:'Progresso', status:'Stato', downSpeed:'Velocità download', upSpeed:'Velocità upload', peers:'Peer', seeds:'Seed', eta:'Tempo stimato', ratio:'Rapporto', added:'Aggiunto', all:'Tutti', downloading:'Download in corso', seeding:'In seed', completed:'Completato', paused:'In pausa', queued:'In coda', error:'Errore', general:'Generale', files:'File', peerList:'Lista peer', trackers:'Tracker', info:'Informazioni', noTorrents:'Nessun Torrent', addMagnet:'Aggiungi magnet', selectFile:'Seleziona file', deleteConfirm:'Confermi eliminazione?', yes:'Sì', totalDown:'Download totale', totalUp:'Upload totale', downloadPath:'Percorso download', maxDown:'Velocità max download', maxUp:'Velocità max upload', unlimited:'Illimitato', save:'Salva', port:'Porta', dht:'DHT', fileName:'Nome file', fileSize:'Dimensione file', fileProg:'Progresso file', peerAddr:'Indirizzo peer', peerClient:'Client', peerDown:'Velocità download', peerUp:'Velocità upload', trackerUrl:'URL tracker', trackerStatus:'Stato tracker', hash:'Hash', created:'Creato', comment:'Commento', creator:'Creatore', private:'Privato', pieces:'Pezzi', pieceLen:'Dimensione pezzo', magnetPlaceholder:'Inserisci link magnet...', magnet:'Magnet', urn:'URN', btih:'BTIH', or:'o', startAll:'Avvia tutti', pauseAll:'Pausa tutti', connected:'Connesso', disconnected:'Disconnesso', notInstalled:'Non installato' }
  };
