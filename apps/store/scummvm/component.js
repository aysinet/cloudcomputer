(function(Vue) {
  ...
  const DOCKER_IMAGE = 'lscr.io/linuxserver/scummvm:latest';
  const APP_ID = 'scummvm';
  ...
  const LANGS = {
    ...
    de: {
      ...
      starting:'ScummVM wird gestartet...',
    ...
    hi: {
      ...
      starting:'ScummVM शुरू हो रहा है...',
