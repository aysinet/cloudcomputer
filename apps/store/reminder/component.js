({
  setup() {
    ...
    const LANGS = {
      tr: {
        title:'Hatırlatıcılar', add:'Yeni Hatırlatıcı', edit:'Düzenle', save:'Kaydet', cancel:'İptal', delete:'Sil',
        titleLabel:'Başlık', noteLabel:'Not', dateTimeLabel:'Tarih & Saat', repeatLabel:'Tekrar',
        noRepeat:'Tekrar Yok', hourly:'Saatlik', daily:'Günlük', weekly:'Haftalık', monthly:'Aylık', custom:'Özel',
        customMinutes:'Dakika (özel aralık)', soundLabel:'Ses', enabled:'Aktif', disabled:'Pasif',
        noReminders:'Henüz hatırlatıcı yok', deleteConfirm:'Bu hatırlatıcıyı silmek istediğinize emin misiniz?',
        snoozed:'Ertelendi', upcoming:'Yaklaşan', past:'Geçmiş', all:'Tümü',
        snooze5:'5dk ertele', snooze15:'15dk ertele', dismiss:'Kapat', titleRequired:'Başlık gerekli',
        dateRequired:'Tarih ve saat gerekli', on:'Açık', off:'Kapalı',
        today:'Bugün', tomorrow:'Yarın', thisWeek:'Bu Hafta', later:'Daha Sonra',
        filterAll:'Tümü', filterActive:'Aktif', filterDisabled:'Pasif'
      },
      en: {
        title:'Reminders', add:'New Reminder', edit:'Edit', save:'Save', cancel:'Cancel', delete:'Delete',
        titleLabel:'Title', noteLabel:'Note', dateTimeLabel:'Date & Time', repeatLabel:'Repeat',
        noRepeat:'No Repeat', hourly:'Hourly', daily:'Daily', weekly:'Weekly', monthly:'Monthly', custom:'Custom',
        customMinutes:'Minutes (custom interval)', soundLabel:'Sound', enabled:'Enabled', disabled:'Disabled',
        noReminders:'No reminders yet', deleteConfirm:'Are you sure you want to delete this reminder?',
        snoozed:'Snoozed', upcoming:'Upcoming', past:'Past', all:'All',
        snooze5:'Snooze 5m', snooze15:'Snooze 15m', dismiss:'Dismiss', titleRequired:'Title is required',
        dateRequired:'Date and time are required', on:'On', off:'Off',
        today:'Today', tomorrow:'Tomorrow', thisWeek:'This Week', later:'Later',
        filterAll:'All', filterActive:'Active', filterDisabled:'Disabled'
      },
      de: {
        title:'Erinnerungen', add:'Neue Erinnerung', edit:'Bearbeiten', save:'Speichern', cancel:'Abbrechen', delete:'Löschen',
        titleLabel:'Titel', noteLabel:'Notiz', dateTimeLabel:'Datum & Uhrzeit', repeatLabel:'Wiederholung',
        noRepeat:'Keine Wiederholung', hourly:'Stündlich', daily:'Täglich', weekly:'Wöchentlich', monthly:'Monatlich', custom:'Benutzerdefiniert',
        customMinutes:'Minuten (benutzerdefiniertes Intervall)', soundLabel:'Ton', enabled:'Aktiviert', disabled:'Deaktiviert',
        noReminders:'Noch keine Erinnerungen', deleteConfirm:'Möchten Sie diese Erinnerung wirklich löschen?',
        snoozed:'Verschoben', upcoming:'Bevorstehend', past:'Vergangen', all:'Alle',
        snooze5:'5 Min. verschieben', snooze15:'15 Min. verschieben', dismiss:'Schließen', titleRequired:'Titel ist erforderlich',
        dateRequired:'Datum und Uhrzeit sind erforderlich', on:'An', off:'Aus',
        today:'Heute', tomorrow:'Morgen', thisWeek:'Diese Woche', later:'Später',
        filterAll:'Alle', filterActive:'Aktiv', filterDisabled:'Deaktiviert'
      },
      fr: {
        title:'Rappels', add:'Nouveau Rappel', edit:'Modifier', save:'Enregistrer', cancel:'Annuler', delete:'Supprimer',
        titleLabel:'Titre', noteLabel:'Note', dateTimeLabel:'Date et Heure', repeatLabel:'Répétition',
        noRepeat:'Pas de répétition', hourly:'Toutes les heures', daily:'Quotidien', weekly:'Hebdomadaire', monthly:'Mensuel', custom:'Personnalisé',
        customMinutes:'Minutes (intervalle personnalisé)', soundLabel:'Son', enabled:'Activé', disabled:'Désactivé',
        noReminders:'Pas encore de rappels', deleteConfirm:'Êtes-vous sûr de vouloir supprimer ce rappel ?',
        snoozed:'Reporté', upcoming:'À venir', past:'Passé', all:'Tous',
        snooze5:'Reporter 5m', snooze15:'Reporter 15m', dismiss:'Fermer', titleRequired:'Le titre est requis',
        dateRequired:'La date et l\'heure sont requises', on:'On', off:'Off',
      ...
      es: {
        title:'Recordatorios', add:'Nuevo Recordatorio', edit:'Editar', save:'Guardar', cancel:'Cancelar', delete:'Eliminar',
        titleLabel:'Título', noteLabel:'Nota', dateTimeLabel:'Fecha y Hora', repeatLabel:'Repetir',
        noRepeat:'Sin repetición', hourly:'Cada hora', daily:'Diario', weekly:'Semanal', monthly:'Mensual', custom:'Personalizado',
        customMinutes:'Minutos (intervalo personalizado)', soundLabel:'Sonido', enabled:'Activado', disabled:'Desactivado',
        noReminders:'Aún no hay recordatorios', deleteConfirm:'¿Estás seguro de que quieres eliminar este recordatorio?',
        snoozed:'Pospuesto', upcoming:'Próximo', past:'Pasado', all:'Todos',
        snooze5:'Posponer 5m', snooze15:'Posponer 15m', dismiss:'Cerrar', titleRequired:'El título es obligatorio',
        dateRequired:'La fecha y hora son obligatorias', on:'On', off:'Off',
        today:'Hoy', tomorrow:'Mañana', thisWeek:'Esta Semana', later:'Más Tarde',
        filterAll:'Todos', filterActive:'Activos', filterDisabled:'Desactivados'
      },
      ru: {
        title:'Напоминания', add:'Новое напоминание', edit:'Редактировать', save:'Сохранить', cancel:'Отмена', delete:'Удалить',
        titleLabel:'Заголовок', noteLabel:'Заметка', dateTimeLabel:'Дата и время', repeatLabel:'Повтор',
        noRepeat:'Без повтора', hourly:'Каждый час', daily:'Ежедневно', weekly:'Еженедельно', monthly:'Ежемесячно', custom:'Пользовательский',
        customMinutes:'Минуты (пользовательский интервал)', soundLabel:'Звук', enabled:'Включено', disabled:'Отключено',
        noReminders:'Пока нет напоминаний', deleteConfirm:'Вы уверены, что хотите удалить это напоминание?',
        snoozed:'Отложено', upcoming:'Предстоящие', past:'Прошедшие', all:'Все',
        snooze5:'Отложить 5м', snooze15:'Отложить 15м', dismiss:'Закрыть', titleRequired:'Заголовок обязателен',
        dateRequired:'Дата и время обязательны', on:'Вкл', off:'Выкл',
