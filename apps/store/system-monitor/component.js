(function(Vue) {
  ...
  const LANGS = {
    tr: {
      server: 'Sunucu', client: 'İstemci', cpu: 'CPU', memory: 'Bellek',
      cores: 'Çekirdek', model: 'Model', total: 'Toplam', used: 'Kullanılan',
      free: 'Boş', uptime: 'Çalışma Süresi', platform: 'Platform',
      hostname: 'Sunucu Adı', arch: 'Mimari', usage: 'Kullanım',
      days: 'gün', hours: 'saat', mins: 'dk', paused: 'Duraklatıldı',
      resume: 'Devam', pause: 'Duraklat', interval: 'Aralık',
      clientNotSupported: 'Tarayıcı performans API desteklenmiyor'
    },
    en: {
      server: 'Server', client: 'Client', cpu: 'CPU', memory: 'Memory',
      cores: 'Cores', model: 'Model', total: 'Total', used: 'Used',
      free: 'Free', uptime: 'Uptime', platform: 'Platform',
      hostname: 'Hostname', arch: 'Architecture', usage: 'Usage',
      days: 'd', hours: 'h', mins: 'm', paused: 'Paused',
      resume: 'Resume', pause: 'Pause', interval: 'Interval',
      clientNotSupported: 'Browser performance API not supported'
    },
    de: {
      server: 'Server', client: 'Client', cpu: 'CPU', memory: 'Speicher',
      cores: 'Kerne', model: 'Modell', total: 'Gesamt', used: 'Belegt',
      free: 'Frei', uptime: 'Laufzeit', platform: 'Plattform',
      hostname: 'Hostname', arch: 'Architektur', usage: 'Nutzung',
      days: 'T', hours: 'Std', mins: 'Min', paused: 'Pausiert',
      resume: 'Fortsetzen', pause: 'Pause', interval: 'Intervall',
      clientNotSupported: 'Browser-Performance-API nicht unterstützt'
    },
    fr: {
      server: 'Serveur', client: 'Client', cpu: 'CPU', memory: 'Mémoire',
      cores: 'Cœurs', model: 'Modèle', total: 'Total', used: 'Utilisé',
      free: 'Libre', uptime: 'Durée', platform: 'Plateforme',
      hostname: 'Nom d\'hôte', arch: 'Architecture', usage: 'Utilisation',
      days: 'j', hours: 'h', mins: 'min', paused: 'En pause',
      resume: 'Reprendre', pause: 'Pause', interval: 'Intervalle',
      clientNotSupported: 'API de performance du navigateur non prise en charge'
    },
    es: {
      server: 'Servidor', client: 'Cliente', cpu: 'CPU', memory: 'Memoria',
      cores: 'Núcleos', model: 'Modelo', total: 'Total', used: 'Usado',
      free: 'Libre', uptime: 'Tiempo activo', platform: 'Plataforma',
      hostname: 'Nombre de host', arch: 'Arquitectura', usage: 'Uso',
      days: 'd', hours: 'h', mins: 'min', paused: 'Pausado',
      resume: 'Reanudar', pause: 'Pausar', interval: 'Intervalo',
      clientNotSupported: 'API de rendimiento del navegador no compatible'
    },
    ru: {
      server: 'Сервер', client: 'Клиент', cpu: 'CPU', memory: 'Память',
      cores: 'Ядра', model: 'Модель', total: 'Всего', used: 'Используется',
      free: 'Свободно', uptime: 'Время работы', platform: 'Платформа',
      hostname: 'Имя хоста', arch: 'Архитектура', usage: 'Использование',
      days: 'д', hours: 'ч', mins: 'мин', paused: 'Пауза',
      resume: 'Продолжить', pause: 'Пауза', interval: 'Интервал',
      clientNotSupported: 'API производительности браузера не поддерживается'
    },
    zh: {
      server: '服务器', client: '客户端', cpu: 'CPU', memory: '内存',
      cores: '核心', model: '型号', total: '总计', used: '已用',
      free: '空闲', uptime: '运行时间', platform: '平台',
      hostname: '主机名', arch: '架构', usage: '使用率',
      days: '天', hours: '时', mins: '分', paused: '已暂停',
      resume: '继续', pause: '暂停', interval: '间隔',
      clientNotSupported: '浏览器性能API不受支持'
    },
    ja: {
      server: 'サーバー', client: 'クライアント', cpu: 'CPU', memory: 'メモリ',
      cores: 'コア', model: 'モデル', total: '合計', used: '使用中',
      free: '空き', uptime: '稼働時間', platform: 'プラットフォーム',
      hostname: 'ホスト名', arch: 'アーキテクチャ', usage: '使用率',
      days: '日', hours: '時', mins: '分', paused: '一時停止',
      resume: '再開', pause: '一時停止', interval: '間隔',
      clientNotSupported: 'ブラウザのパフォーマンスAPIがサポートされていません'
    },
    it: {
      server: 'Server', client: 'Client', cpu: 'CPU', memory: 'Memoria',
      cores: 'Core', model: 'Modello', total: 'Totale', used: 'Usato',
      free: 'Libero', uptime: 'Tempo attivo', platform: 'Piattaforma',
      hostname: 'Nome host', arch: 'Architettura', usage: 'Utilizzo',
      days: 'g', hours: 'h', mins: 'min', paused: 'In pausa',
      resume: 'Riprendi', pause: 'Pausa', interval: 'Intervallo',
