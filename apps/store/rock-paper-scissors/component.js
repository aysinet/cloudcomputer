(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      newGame:'Yeni Oyun',
      resetAll:'Sıfırla',
      winMatch:'Maçı Kazandın! 🎉',
      loseMatch:'Maçı Kaybettin!',
      tiedMatch:'Maç Berabere!'
    },
    en: {
      you:'You',
      cpu:'Computer',
      ...
      newGame:'New Game',
      resetAll:'Reset All',
      winMatch:'You Won the Match! 🎉',
      loseMatch:'You Lost the Match!',
      tiedMatch:'Match Tied!'
    },
    de: {
      you:'Du',
      cpu:'Computer',
      ...
      winMatch:'Du hast gewonnen! 🎉',
      loseMatch:'Du hast verloren!',
      tiedMatch:'Unentschieden!'
    },
    fr: {
      you:'Vous',
      cpu:'Ordinateur',
      ...
      winMatch:'Vous avez gagné ! 🎉',
      loseMatch:'Vous avez perdu !',
      tiedMatch:'Match nul !'
    },
    es: {
      you:'Tú',
      ...
      newGame:'Nuevo Juego',
      resetAll:'Reiniciar',
      winMatch:'¡Ganaste el partido! 🎉',
      loseMatch:'¡Perdiste el partido!',
    ...
    ru: {
      ...
      newGame:'Новая игра',
      resetAll:'Сброс',
      winMatch:'Вы выиграли матч! 🎉',
      loseMatch:'Вы проиграли матч!',
      tiedMatch:'Матч ничья!'
    },
    zh: {
      you:'你',
      cpu:'电脑',
    ...
    it: {
      ...
      resetAll:'Reset',
      winMatch:'Hai vinto la partita! 🎉',
      loseMatch:'Hai perso la partita!',
      tiedMatch:'Partita pareggiata!'
    },
    ar: {
      you:'أنت',
      cpu:'Computer',
