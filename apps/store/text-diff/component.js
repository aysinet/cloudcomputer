  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        fileMode:'Dosya',
        folderMode:'Klasör',
        original:'Orijinal (Sol)',
        modified:'Değiştirilmiş (Sağ)',
        openLeft:'Sol Dosya Aç',
        openRight:'Sağ Dosya Aç',
        pasteLeft:'Sol Yapıştır',
        pasteRight:'Sağ Yapıştır',
        swap:'Takas',
        clear:'Temizle',
        sideBySide:'Yan Yana',
        inline:'Satır İçi',
        leftFolder:'Sol Klasör',
        rightFolder:'Sağ Klasör',
        browseLeft:'Sol Seç',
        browseRight:'Sağ Seç',
        compareFolders:'Klasörleri Karşılaştır',
        onlyLeft:'Sadece Solda',
        onlyRight:'Sadece Sağda',
        different:'Farklı',
        identical:'Aynı',
        fileName:'Dosya Adı',
        status:'Durum',
        ...
        copyToRight:'Sola Kopyala → Sağa',
        copyToLeft:'Sağdan ← Sola Kopyala',
        prevDiff:'Önceki Fark',
        nextDiff:'Sonraki Fark',
        wordWrap:'Sözcük Kaydır',
        fontSize:'Yazı Boyutu',
        placeholderLeft:'Sol metni buraya yapıştırın veya yazın...',
      ...
      en: {
        ...
        openLeft:'Open Left File',
        openRight:'Open Right File',
        ...
        copyToRight:'Copy Left → Right',
        copyToLeft:'Copy Right → Left',
        prevDiff:'Previous Diff',
        nextDiff:'Next Diff',
        wordWrap:'Word Wrap',
        fontSize:'Font Size',
        placeholderLeft:'Paste or type left text here...',
      ...
      de: {
        ...
        fileMode:'Datei',
        folderMode:'Ordner',
        original:'Original (Links)',
        modified:'Geändert (Rechts)',
        openLeft:'Linke Datei öffnen',
        openRight:'Rechte Datei öffnen',
        pasteLeft:'Links einfügen',
        pasteRight:'Rechts einfügen',
        swap:'Tauschen',
        clear:'Löschen',
        sideBySide:'Nebeneinander',
        inline:'Inline',
        leftFolder:'Linker Ordner',
        rightFolder:'Rechter Ordner',
        browseLeft:'Links durchsuchen',
        browseRight:'Rechts durchsuchen',
        compareFolders:'Ordner vergleichen',
        onlyLeft:'Nur links',
        onlyRight:'Nur rechts',
        ...
        copyToRight:'Links → Rechts kopieren',
        copyToLeft:'Rechts → Links kopieren',
        prevDiff:'Vorheriger Unterschied',
        nextDiff:'Nächster Unterschied',
        wordWrap:'Zeilenumbruch',
        fontSize:'Schriftgröße',
        placeholderLeft:'Linken Text hier einfügen...',
        placeholderRight:'Rechten Text hier einfügen...',
        leftPath:'Linker Pfad',
        rightPath:'Rechter Pfad',
        stats:'Statistiken',
        added:'hinzugefügt',
        removed:'entfernt',
      ...
      fr: {
        ...
        fileMode:'Fichier',
        folderMode:'Dossier',
        original:'Original (Gauche)',
        modified:'Modifié (Droite)',
        openLeft:'Ouvrir fichier gauche',
        openRight:'Ouvrir fichier droite',
        pasteLeft:'Coller à gauche',
        pasteRight:'Coller à droite',
        swap:'Échanger',
        clear:'Effacer',
        sideBySide:'Côte à côte',
        inline:'En ligne',
        leftFolder:'Dossier gauche',
        rightFolder:'Dossier droite',
        browseLeft:'Parcourir gauche',
        browseRight:'Parcourir droite',
        compareFolders:'Comparer les dossiers',
        onlyLeft:'Uniquement à gauche',
        onlyRight:'Uniquement à droite',
        different:'Différent',
        identical:'Identique',
        ...
        copyToRight:'Copier gauche → droite',
        copyToLeft:'Copier droite → gauche',
        prevDiff:'Diff précédent',
        nextDiff:'Diff suivant',
        wordWrap:'Retour à la ligne',
        fontSize:'Taille de police',
        placeholderLeft:'Collez ou tapez le texte gauche ici...',
        placeholderRight:'Collez ou tapez le texte droite ici...',
        leftPath:'Chemin gauche',
        rightPath:'Chemin droite',
        stats:'statistiques',
        added:'ajouté',
        removed:'supprimé',
        unchanged:'inchangé',
      ...
      es: {
        ...
        fileMode:'Archivo',
        folderMode:'Carpeta',
        original:'Original (Izquierda)',
        modified:'Modificado (Derecha)',
        openLeft:'Abrir archivo izquierdo',
        openRight:'Abrir archivo derecho',
        pasteLeft:'Pegar izquierda',
        pasteRight:'Pegar derecha',
        swap:'Intercambiar',
        clear:'Limpiar',
        sideBySide:'Lado a lado',
        inline:'En línea',
        leftFolder:'Carpeta izquierda',
        rightFolder:'Carpeta derecha',
        browseLeft:'Examinar izquierda',
        browseRight:'Examinar derecha',
        compareFolders:'Comparar carpetas',
        onlyLeft:'Solo en izquierda',
        onlyRight:'Solo en derecha',
        different:'Diferente',
        identical:'Idéntico',
        ...
        copyToRight:'Copiar izquierda → derecha',
        copyToLeft:'Copiar derecha → izquierda',
        prevDiff:'Diff anterior',
        nextDiff:'Diff siguiente',
        wordWrap:'Ajuste de línea',
        fontSize:'Tamaño de fuente',
        placeholderLeft:'Pegue o escriba el texto izquierdo aquí...',
        placeholderRight:'Pegue o escriba el texto derecho aquí...',
        leftPath:'Ruta izquierda',
        rightPath:'Ruta derecha',
        stats:'estadísticas',
        added:'añadido',
        removed:'eliminado',
      ...
      ru: {
        ...
        fileMode:'Файл',
        folderMode:'Папка',
        original:'Оригинал (Левый)',
        modified:'Изменённый (Правый)',
        openLeft:'Открыть левый файл',
        openRight:'Открыть правый файл',
        pasteLeft:'Вставить слева',
        pasteRight:'Вставить справа',
        swap:'Поменять',
        clear:'Очистить',
        sideBySide:'Рядом',
        inline:'Построчно',
        leftFolder:'Левая папка',
        rightFolder:'Правая папка',
        browseLeft:'Обзор слева',
        browseRight:'Обзор справа',
        compareFolders:'Сравнить папки',
        onlyLeft:'Только слева',
        onlyRight:'Только справа',
        different:'Разные',
        ...
        copyToRight:'Копировать лево → право',
        copyToLeft:'Копировать право → лево',
        prevDiff:'Предыдущее',
        nextDiff:'Следующее',
        wordWrap:'Перенос слов',
        fontSize:'Размер шрифта',
        placeholderLeft:'Вставьте или введите левый текст...',
        placeholderRight:'Вставьте или введите правый текст...',
        leftPath:'Левый путь',
        rightPath:'Правый путь',
        stats:'статистика',
        added:'добавлено',
        removed:'удалено',
      ...
      zh: {
        ...
        wordWrap:'自动换行',
        fontSize:'字体大小',
        placeholderLeft:'在此粘贴原始文本...',
        placeholderRight:'在此粘贴修改后的文本...',
        leftPath:'左侧路径',
        rightPath:'右侧路径',
        stats:'统计',
        added:'新增',
      ...
      ja: {
        ...
        wordWrap:'折り返し',
        fontSize:'文字サイズ',
        placeholderLeft:'元のテキストを貼り付け...',
        placeholderRight:'変更後のテキストを貼り付け...',
        leftPath:'左パス',
        rightPath:'右パス',
        stats:'統計',
        added:'追加',
      ...
      it: {
        ...
        original:'Originale',
        modified:'Modificato',
        openLeft:'Apri sinistra',
        openRight:'Apri destra',
        pasteLeft:'Incolla sinistra',
        pasteRight:'Incolla destra',
        swap:'Scambia',
        clear:'Cancella',
        sideBySide:'Affiancato',
        inline:'In linea',
        leftFolder:'Cartella sinistra',
        rightFolder:'Cartella destra',
        browseLeft:'Sfoglia sinistra',
        browseRight:'Sfoglia destra',
        compareFolders:'Confronta cartelle',
        onlyLeft:'Solo sinistra',
        onlyRight:'Solo destra',
        different:'Diversi',
        identical:'Identici',
        fileName:'Nome file',
        status:'Stato',
        ...
        noDiff:'Nessuna differenza',
        copyToRight:'Copia a destra',
        copyToLeft:'Copia a sinistra',
        prevDiff:'Differenza precedente',
        nextDiff:'Differenza successiva',
        wordWrap:'A capo',
        fontSize:'Dimensione testo',
        placeholderLeft:'Incolla testo originale...',
        placeholderRight:'Incolla testo modificato...',
        leftPath:'Percorso sinistro',
        rightPath:'Percorso destro',
        stats:'Statistiche',
        added:'Aggiunte',
        removed:'Rimosse',
        unchanged:'Invariate',
