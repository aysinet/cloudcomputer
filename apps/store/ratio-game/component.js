({
  setup() {
    ...
    const LANGS = {
      tr: { title:'Oran Oyunu', round:'Tur', next:'İleri', results:'Sonuçlar', resultsTitle:'Sonuçlar', bestCut:'En iyi kesim', avgBias:'Ortalama sapma', playAgain:'Tekrar Oyna', howToPlay:'Nasıl oynanır', helpText:'10 tur var. Kesim çizgisini dairedeki hedef kesre göre ayarlayın, sonra tıklayarak dilimleyin.', moveAndSlice:'Kesim çizgisini hareket ettir. Tıkla ve dilimle.', viewResults:'Sonuçları görüntüle.', clickNext:'İleri\'ye tıklayın.', youCut:'Kesiminiz', offBy:'Sapma' },
      en: { title:'Ratio Game', round:'Round', next:'Next', results:'Results', resultsTitle:'Results', bestCut:'Best cut', avgBias:'Average bias', playAgain:'Play again', howToPlay:'How to play', helpText:'There are 10 rounds. Match the target fraction by moving the cut line around the circle, then click to slice.', moveAndSlice:'Move the cut line. Click to slice.', viewResults:'View your results.', clickNext:'Click Next to continue.', youCut:'You cut', offBy:'Off by' },
      de: { title:'Bruch-Spiel', round:'Runde', next:'Weiter', results:'Ergebnis', resultsTitle:'Ergebnisse', bestCut:'Bester Schnitt', avgBias:'Durchschn. Abweichung', playAgain:'Nochmal', howToPlay:'Spielanleitung', helpText:'10 Runden. Bewege die Schnittlinie und klicke zum Schneiden.', moveAndSlice:'Schnittlinie bewegen. Klicken zum Schneiden.', viewResults:'Ergebnisse anzeigen.', clickNext:'Klicke Weiter.', youCut:'Dein Schnitt', offBy:'Abweichung' },
      fr: { title:'Jeu de Fractions', round:'Tour', next:'Suivant', results:'Résultats', resultsTitle:'Résultats', bestCut:'Meilleure coupe', avgBias:'Biais moyen', playAgain:'Rejouer', howToPlay:'Comment jouer', helpText:'10 tours. Déplacez la ligne de coupe et cliquez pour couper.', moveAndSlice:'Déplacez la ligne. Cliquez pour couper.', viewResults:'Voir les résultats.', clickNext:'Cliquez sur Suivant.', youCut:'Votre coupe', offBy:'Écart' },
      es: { title:'Juego de Fracciones', round:'Ronda', next:'Siguiente', results:'Resultados', resultsTitle:'Resultados', bestCut:'Mejor corte', avgBias:'Sesgo promedio', playAgain:'Jugar de nuevo', howToPlay:'Cómo jugar', helpText:'10 rondas. Mueve la línea de corte y haz clic para cortar.', moveAndSlice:'Mueve la línea. Haz clic para cortar.', viewResults:'Ver resultados.', clickNext:'Haz clic en Siguiente.', youCut:'Tu corte', offBy:'Desviación' },
      ru: { title:'Игра дробей', round:'Раунд', next:'Далее', results:'Результаты', resultsTitle:'Результаты', bestCut:'Лучший разрез', avgBias:'Средн. смещение', playAgain:'Играть снова', howToPlay:'Как играть', helpText:'10 раундов. Двигайте линию разреза и кликните, чтобы разрезать.', moveAndSlice:'Двигайте линию. Кликните для разреза.', viewResults:'Посмотреть результаты.', clickNext:'Нажмите Далее.', youCut:'Ваш разрез', offBy:'Отклонение' },
      zh: { title:'分数游戏', round:'轮', next:'下一轮', results:'结果', resultsTitle:'结果', bestCut:'最佳切割', avgBias:'平均偏差', playAgain:'再玩一次', howToPlay:'玩法', helpText:'共10轮。移动切割线并点击切割。', moveAndSlice:'移动切割线，点击切割。', viewResults:'查看结果。', clickNext:'点击下一轮。', youCut:'你的切割', offBy:'偏差' },
      ja: { title:'分数ゲーム', round:'ラウンド', next:'次へ', results:'結果', resultsTitle:'結果', bestCut:'最高カット', avgBias:'平均バイアス', playAgain:'もう一度', howToPlay:'遊び方', helpText:'全10ラウンド。カットラインを動かしてクリックで切断。', moveAndSlice:'カットラインを動かしてクリック。', viewResults:'結果を見る。', clickNext:'次へをクリック。', youCut:'カット', offBy:'誤差' },
      it: { title:'Gioco Frazioni', round:'Turno', next:'Avanti', results:'Risultati', resultsTitle:'Risultati', bestCut:'Miglior taglio', avgBias:'Bias medio', playAgain:'Gioca ancora', howToPlay:'Come si gioca', helpText:'10 turni. Muovi la linea di taglio e clicca per tagliare.', moveAndSlice:'Muovi la linea. Clicca per tagliare.', viewResults:'Vedi i risultati.', clickNext:'Clicca Avanti.', youCut:'Il tuo taglio', offBy:'Scarto' }
    };
