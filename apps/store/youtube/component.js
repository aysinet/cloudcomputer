(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      trendingError:'Trendler yüklenemedi',
      urlError:'Geçersiz YouTube URL',
      ago:'önce',
      home:'Ana Sayfa'
    },
    en: {
      ...
      trendingError:'Could not load trends',
      urlError:'Invalid YouTube URL',
      ago:'ago',
      home:'Home'
    },
    de: {
      search:'Suchen',
      searchPlaceholder:'Auf YouTube suchen...',
      trending:'Trends',
      favorites:'Favoriten',
      history:'Verlauf',
      ...
      trendingError:'Trends konnten nicht geladen werden',
      urlError:'Ungültige YouTube-URL',
      ago:'vor',
      home:'Startseite'
    },
    fr: {
      ...
      trendingError:'Impossible de charger les tendances',
      urlError:'URL YouTube invalide',
      ago:'il y a',
      home:'Accueil'
    },
    es: {
      ...
      trendingError:'No se pudieron cargar las tendencias',
      urlError:'URL de YouTube no válida',
      ago:'hace',
      home:'Inicio'
    },
    ru: {
      search:'Поиск',
      searchPlaceholder:'Искать на YouTube...',
      trending:'Тренды',
      favorites:'Избранное',
      history:'История',
      ...
      trendingError:'Не удалось загрузить тренды',
      urlError:'Неверный URL YouTube',
      ago:'назад',
      home:'Главная'
    },
    zh: {
