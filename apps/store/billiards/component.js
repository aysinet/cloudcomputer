  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        win:'Kazandın!',
        lose:'Kaybettin!',
        eightBall:'8-Top Bilardo',
        power:'Güç',
        aim:'Nişan al ve tıkla',
        restart:'Tekrar Oyna',
        score:'Skor',
        cueBall:'Beyaz top cebe girdi — faul',
        wrongBall:'Yanlış top — faul',
        gameOver:'Oyun Bitti',
        player:'Oyuncu',
        ai:'Bilgisayar'
      },
      en: {
        ...
        power:'Power',
        aim:'Aim and click to shoot',
        restart:'Play Again',
        score:'Score',
        cueBall:'Cue ball pocketed — foul',
        wrongBall:'Wrong ball — foul',
        gameOver:'Game Over',
        player:'Player',
        ai:'Computer'
      },
      de: {
        ...
        win:'Du gewinnst!',
        lose:'Du verlierst!',
        eightBall:'8-Ball Billard',
        power:'Stärke',
        aim:'Zielen und klicken',
        restart:'Nochmal spielen',
        score:'Punkte',
        cueBall:'Weiße Kugel eingelocht — Foul',
        wrongBall:'Falsche Kugel — Foul',
      ...
      fr: {
        ...
        win:'Vous gagnez!',
        lose:'Vous perdez!',
        eightBall:'Billard 8 boules',
        power:'Puissance',
        aim:'Visez et cliquez',
        restart:'Rejouer',
        score:'Score',
        cueBall:'Blanche empochée — faute',
        wrongBall:'Mauvaise boule — faute',
      ...
      es: {
        ...
        win:'¡Ganaste!',
        lose:'¡Perdiste!',
        eightBall:'Billar 8 bolas',
        power:'Potencia',
        aim:'Apunta y haz clic',
        restart:'Jugar de nuevo',
        score:'Puntuación',
        cueBall:'Bola blanca embocada — falta',
        wrongBall:'Bola equivocada — falta',
      ...
      ru: {
        ...
        win:'Вы победили!',
        lose:'Вы проиграли!',
        eightBall:'Бильярд 8 шаров',
        power:'Сила',
        aim:'Прицельтесь и нажмите',
        restart:'Играть снова',
        score:'Счёт',
        cueBall:'Биток в лузе — фол',
        wrongBall:'Неверный шар — фол',
      ...
      ja: {
        ...
        restart:'もう一度',
        score:'スコア',
        cueBall:'手球ポケットイン — ファウル',
        wrongBall:'間違った球 — ファウル',
        gameOver:'ゲームオーバー',
        player:'プレイヤー',
        ai:'コンピュータ'
      },
      it: {
        ...
        win:'Hai vinto!',
        lose:'Hai perso!',
        eightBall:'Biliardo 8 palle',
        power:'Potenza',
        aim:'Mira e clicca',
        restart:'Gioca ancora',
        score:'Punteggio',
        cueBall:'Palla bianca in buca — fallo',
        wrongBall:'Palla sbagliata — fallo',
