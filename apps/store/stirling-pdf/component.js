(function(Vue) {
  ...
  const DOCKER_IMAGE = 'stirlingtools/stirling-pdf:latest';
  const APP_ID = 'stirling-pdf';
  ...
  return {
    setup() {
      ...
      function getVolumes() {
        return [
          '${APP_VOLUME}:/configs',
          '${APP_VOLUME}/logs:/logs',
          '${APP_VOLUME}/customFiles:/customFiles',
          '${APP_VOLUME}/pipeline:/pipeline'
        ];
      }
      ...
      async function pullImage() {
        ...
        try {
          ...
          pullProgress.value = 'Image indirildi! Stirling PDF başlatılıyor...';
          await checkAndStart();
        } catch (e) {
