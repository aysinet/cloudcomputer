(function(Vue) {
  ...
  const DOCKER_IMAGE = 'etherpad/etherpad:latest';
  const APP_ID = 'etherpad';
  const CONTAINER_PORT = 9001;
  ...
  return {
    setup() {
      ...
      function getVolumes() {
        return [
          '${APP_VOLUME}:/opt/etherpad-lite/var'
        ];
      }
      ...
      async function pullImage() {
        ...
        try {
          ...
          pullProgress.value = 'Image indirildi! Etherpad başlatılıyor...';
          await checkAndStart();
        } catch (e) {
