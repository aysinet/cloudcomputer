  ...
  setup() {
    ...
    const LANGS = {
      tr: {
        ...
        selection:'Seçim',
        cursor:'İmleç',
        loadAudio:'Ses dosyası yüklemek için tıklayın',
        openFile:'Dosya Aç',
        musicFiles:'Müzik Dosyaları',
        recordings:'Kayıtlar',
        browse:'Gözat',
        noFiles:'Dosya bulunamadı',
        cancel:'İptal',
        exportTitle:'WAV Dışa Aktar',
        filename:'Dosya Adı',
        saveLocation:'Kayıt Yeri',
        musicFolder:'Müzik Klasörü',
        recordingsFolder:'Kayıtlar Klasörü',
        ...
        gainDb:'Kazanç (dB)',
        noSelection:'Lütfen bir bölge seçin',
        fx_gain:'Ses Kazancı',
        fx_fadeIn:'Fade In',
        fx_fadeOut:'Fade Out',
        fx_normalize:'Normalize',
        fx_reverse:'Ters Çevir',
        fx_silence:'Sessizlik',
        fx_amplify:'Yükselt',
        fx_invert:'Faz Ters Çevir',
      ...
      en: {
        ...
        selection:'Selection',
        cursor:'Cursor',
        loadAudio:'Click to load an audio file',
        openFile:'Open File',
        ...
        exporting:'Exporting...',
        gainDb:'Gain (dB)',
        noSelection:'Please select a region',
        fx_gain:'Gain',
        fx_fadeIn:'Fade In',
        fx_fadeOut:'Fade Out',
        fx_normalize:'Normalize',
      ...
      de: {
        ...
        selection:'Auswahl',
        cursor:'Cursor',
        loadAudio:'Klicken um Audiodatei zu laden',
        openFile:'Datei öffnen',
        musicFiles:'Musikdateien',
        recordings:'Aufnahmen',
        browse:'Durchsuchen',
        noFiles:'Keine Dateien gefunden',
        cancel:'Abbrechen',
        exportTitle:'WAV exportieren',
        filename:'Dateiname',
        saveLocation:'Speicherort',
        musicFolder:'Musikordner',
        recordingsFolder:'Aufnahmenordner',
        downloadLocal:'Auf Computer herunterladen',
        success:'Erfolgreich',
        error:'Fehler',
        ...
        gainDb:'Verstärkung (dB)',
        noSelection:'Bitte wählen Sie einen Bereich',
        fx_gain:'Verstärkung',
        fx_fadeIn:'Einblenden',
        fx_fadeOut:'Ausblenden',
        fx_normalize:'Normalisieren',
        fx_reverse:'Umkehren',
        fx_silence:'Stille',
        fx_amplify:'Verstärken',
        fx_invert:'Phase umkehren',
      ...
      fr: {
        ...
        selection:'Sélection',
        cursor:'Curseur',
        loadAudio:'Cliquez pour charger un fichier audio',
        openFile:'Ouvrir un fichier',
        musicFiles:'Fichiers musique',
        recordings:'Enregistrements',
        browse:'Parcourir',
        noFiles:'Aucun fichier trouvé',
        cancel:'Annuler',
        exportTitle:'Exporter WAV',
        filename:'Nom du fichier',
        saveLocation:'Emplacement',
        musicFolder:'Dossier Musique',
        recordingsFolder:'Dossier Enregistrements',
        downloadLocal:'Télécharger sur l\'ordinateur',
        success:'Succès',
        error:'Erreur',
        ...
        gainDb:'Gain (dB)',
        noSelection:'Veuillez sélectionner une région',
        fx_gain:'Gain',
        fx_fadeIn:'Fondu d\'entrée',
        fx_fadeOut:'Fondu de sortie',
        fx_normalize:'Normaliser',
        fx_reverse:'Inverser',
        fx_silence:'Silence',
        fx_amplify:'Amplifier',
        fx_invert:'Inverser la phase',
      ...
      es: {
        ...
        selection:'Selección',
        cursor:'Cursor',
        loadAudio:'Haga clic para cargar un archivo de audio',
        ...
        cancel:'Cancelar',
        exportTitle:'Exportar WAV',
        filename:'Nombre del archivo',
        saveLocation:'Ubicación',
        musicFolder:'Carpeta de Música',
        recordingsFolder:'Carpeta de Grabaciones',
        downloadLocal:'Descargar al ordenador',
        success:'Éxito',
        error:'Error',
        ...
        gainDb:'Ganancia (dB)',
        noSelection:'Seleccione una región',
        fx_gain:'Ganancia',
        fx_fadeIn:'Fundido de entrada',
        fx_fadeOut:'Fundido de salida',
        fx_normalize:'Normalizar',
        fx_reverse:'Invertir',
        fx_silence:'Silencio',
        fx_amplify:'Amplificar',
        fx_invert:'Invertir fase',
      ...
      ru: {
        ...
        selection:'Выделение',
        cursor:'Курсор',
        loadAudio:'Нажмите для загрузки аудиофайла',
        openFile:'Открыть файл',
        musicFiles:'Музыкальные файлы',
        recordings:'Записи',
        browse:'Обзор',
        noFiles:'Файлы не найдены',
        cancel:'Отмена',
        exportTitle:'Экспорт WAV',
        filename:'Имя файла',
        saveLocation:'Место сохранения',
        musicFolder:'Папка Музыки',
        recordingsFolder:'Папка Записей',
        downloadLocal:'Скачать на компьютер',
        success:'Успешно',
        error:'Ошибка',
        ...
        exporting:'Экспорт...',
        gainDb:'Усиление (дБ)',
        noSelection:'Выберите область',
        fx_gain:'Усиление',
        fx_fadeIn:'Нарастание',
        fx_fadeOut:'Затухание',
        fx_normalize:'Нормализация',
        fx_reverse:'Реверс',
        fx_silence:'Тишина',
        fx_amplify:'Усилить',
        fx_invert:'Инверсия фазы',
      ...
      it: {
        ...
        openFile:'Apri file',
        musicFiles:'File musicali',
        recordings:'Registrazioni',
        browse:'Sfoglia',
        noFiles:'Nessun file',
        cancel:'Annulla',
        exportTitle:'Esporta audio',
        filename:'Nome file',
        saveLocation:'Posizione',
        musicFolder:'Cartella musica',
        ...
        fx_gain:'Guadagno',
        fx_fadeIn:'Dissolvenza in entrata',
        fx_fadeOut:'Dissolvenza in uscita',
        fx_normalize:'Normalizza',
        fx_reverse:'Inverti',
        fx_silence:'Silenzio',
        fx_amplify:'Amplifica',
        fx_invert:'Inverti fase',
