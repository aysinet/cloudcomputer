({
  setup() {
    ...
    zh: { title:'单位转换器', category:'类别', from:'从', to:'到', selectUnit:'选择单位', formula:'公式', quickRef:'快速参考', cancel:'关闭', cat_length:'长度', cat_weight:'重量', cat_temperature:'温度', cat_area:'面积', cat_volume:'体积', cat_speed:'速度', cat_time:'时间', cat_data:'数据', cat_pressure:'压力', cat_energy:'能量', unit_mm:'毫米', unit_cm:'厘米', unit_m:'米', unit_km:'千米', unit_inch:'英寸', unit_foot:'英尺', unit_yard:'码', unit_mile:'英里', unit_nautical_mile:'海里', unit_mg:'毫克', unit_g:'克', unit_kg:'千克', unit_ton:'吨', unit_ounce:'盎司', unit_pound:'磅', unit_stone:'英石', unit_celsius:'摄氏度', unit_fahrenheit:'华氏度', unit_kelvin:'开尔文', unit_sqmm:'平方毫米', unit_sqcm:'平方厘米', unit_sqm:'平方米', unit_hectare:'公顷', unit_sqkm:'平方千米', unit_sqinch:'平方英寸', unit_sqfoot:'平方英尺', unit_acre:'英亩', unit_sqmile:'平方英里', unit_ml:'毫升', unit_liter:'升', unit_cubicm:'立方米', unit_gallon_us:'美制加仑', unit_gallon_uk:'英制加仑', unit_quart:'夸脱', unit_pint:'品脱', unit_cup:'杯', unit_floz:'液量盎司', unit_mps:'米/秒', unit_kmh:'千米/时', unit_mph:'英里/时', unit_knot:'节', unit_fps:'英尺/秒', unit_ms:'毫秒', unit_second:'秒', unit_minute:'分钟', unit_hour:'小时', unit_day:'天', unit_week:'周', unit_month:'月', unit_year:'年', unit_bit:'比特', unit_byte:'字节', unit_kb:'KB', unit_mb:'MB', unit_gb:'GB', unit_tb:'TB', unit_pascal:'帕斯卡', unit_kpa:'千帕', unit_bar:'巴', unit_atm:'标准大气压', unit_psi:'磅/平方英寸', unit_mmhg:'毫米汞柱', unit_joule:'焦耳', unit_kj:'千焦', unit_calorie:'卡路里', unit_kcal:'千卡', unit_wh:'瓦时', unit_kwh:'千瓦时', unit_btu:'英热单位' },
    ja: { title:'単位変換', category:'カテゴリ', from:'変換元', to:'変換先', selectUnit:'単位を選択', formula:'計算式', quickRef:'クイックリファレンス', cancel:'閉じる', cat_length:'長さ', cat_weight:'重さ', cat_temperature:'温度', cat_area:'面積', cat_volume:'体積', cat_speed:'速度', cat_time:'時間', cat_data:'データ', cat_pressure:'圧力', cat_energy:'エネルギー', unit_mm:'ミリメートル', unit_cm:'センチメートル', unit_m:'メートル', unit_km:'キロメートル', unit_inch:'インチ', unit_foot:'フィート', unit_yard:'ヤード', unit_mile:'マイル', unit_nautical_mile:'海里', unit_mg:'ミリグラム', unit_g:'グラム', unit_kg:'キログラム', unit_ton:'トン', unit_ounce:'オンス', unit_pound:'ポンド', unit_stone:'ストーン', unit_celsius:'摂氏', unit_fahrenheit:'華氏', unit_kelvin:'ケルビン', unit_sqmm:'平方ミリ', unit_sqcm:'平方センチ', unit_sqm:'平方メートル', unit_hectare:'ヘクタール', unit_sqkm:'平方キロ', unit_sqinch:'平方インチ', unit_sqfoot:'平方フィート', unit_acre:'エーカー', unit_sqmile:'平方マイル', unit_ml:'ミリリットル', unit_liter:'リットル', unit_cubicm:'立方メートル', unit_gallon_us:'米ガロン', unit_gallon_uk:'英ガロン', unit_quart:'クォート', unit_pint:'パイント', unit_cup:'カップ', unit_floz:'液量オンス', unit_mps:'メートル/秒', unit_kmh:'キロ/時', unit_mph:'マイル/時', unit_knot:'ノット', unit_fps:'フィート/秒', unit_ms:'ミリ秒', unit_second:'秒', unit_minute:'分', unit_hour:'時間', unit_day:'日', unit_week:'週', unit_month:'月', unit_year:'年', unit_bit:'ビット', unit_byte:'バイト', unit_kb:'KB', unit_mb:'MB', unit_gb:'GB', unit_tb:'TB', unit_pascal:'パスカル', unit_kpa:'キロパスカル', unit_bar:'バール', unit_atm:'気圧', unit_psi:'PSI', unit_mmhg:'mmHg', unit_joule:'ジュール', unit_kj:'キロジュール', unit_calorie:'カロリー', unit_kcal:'キロカロリー', unit_wh:'ワット時', unit_kwh:'キロワット時', unit_btu:'BTU' },
    it: { title:'Convertitore Unità', category:'Categoria', from:'Da', to:'A', selectUnit:'Seleziona unità', formula:'Formula', quickRef:'Riferimento rapido', cancel:'Chiudi', cat_length:'Lunghezza', cat_weight:'Peso', cat_temperature:'Temperatura', cat_area:'Area', cat_volume:'Volume', cat_speed:'Velocità', cat_time:'Tempo', cat_data:'Dati', cat_pressure:'Pressione', cat_energy:'Energia', unit_mm:'Millimetri', unit_cm:'Centimetri', unit_m:'Metri', unit_km:'Chilometri', unit_inch:'Pollici', unit_foot:'Piedi', unit_yard:'Iarde', unit_mile:'Miglia', unit_nautical_mile:'Miglia nautiche', unit_mg:'Milligrammi', unit_g:'Grammi', unit_kg:'Chilogrammi', unit_ton:'Tonnellate', unit_ounce:'Once', unit_pound:'Libbre', unit_stone:'Stone', unit_celsius:'Celsius', unit_fahrenheit:'Fahrenheit', unit_kelvin:'Kelvin', unit_sqmm:'mm²', unit_sqcm:'cm²', unit_sqm:'m²', unit_hectare:'Ettari', unit_sqkm:'km²', unit_sqinch:'in²', unit_sqfoot:'ft²', unit_acre:'Acri', unit_sqmile:'mi²', unit_ml:'Millilitri', unit_liter:'Litri', unit_cubicm:'m³', unit_gallon_us:'Galloni US', unit_gallon_uk:'Galloni UK', unit_quart:'Quarti', unit_pint:'Pinte', unit_cup:'Tazze', unit_floz:'Once liquide', unit_mps:'m/s', unit_kmh:'km/h', unit_mph:'mph', unit_knot:'Nodi', unit_fps:'ft/s', unit_ms:'Millisecondi', unit_second:'Secondi', unit_minute:'Minuti', unit_hour:'Ore', unit_day:'Giorni', unit_week:'Settimane', unit_month:'Mesi', unit_year:'Anni', unit_bit:'Bit', unit_byte:'Byte', unit_kb:'KB', unit_mb:'MB', unit_gb:'GB', unit_tb:'TB', unit_pascal:'Pascal', unit_kpa:'Kilopascal', unit_bar:'Bar', unit_atm:'Atmosfere', unit_psi:'PSI', unit_mmhg:'mmHg', unit_joule:'Joule', unit_kj:'Kilojoule', unit_calorie:'Calorie', unit_kcal:'Kilocalorie', unit_wh:'Wattora', unit_kwh:'Kilowattora', unit_btu:'BTU' }
  };
