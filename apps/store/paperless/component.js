(function(Vue) {
  ...
  const DOCKER_IMAGE = 'paperlessngx/paperless-ngx:latest';
  const APP_ID = 'paperless';
    ...
    setup() {
      ...
      function getEnv() {
        return [
          ...
          'PAPERLESS_OCR_LANGUAGES=tur eng deu fra spa',
      ...
      async function pullImage() {
        ...
        try {
          ...
          pullProgress.value = 'Image indirildi! Paperless-ngx başlatılıyor...';
          await checkAndStart();
        } catch (e) {
