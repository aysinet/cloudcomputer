(function(Vue) {
  ...
  const LANGS = {
    tr: {
      ...
      newEntry:'Yeni Kayıt',
      lblTitle:'Başlık',
      titlePlaceholder:'Örn: Gmail',
      lblGroup:'Grup',
      lblUsername:'Kullanıcı Adı',
      userPlaceholder:'kullanici@mail.com',
      lblPassword:'Şifre',
      lblUrl:'URL',
      lblNotes:'Notlar',
      genPassword:'Şifre üret',
      genTitle:'Şifre Üretici',
      genLength:'Uzunluk',
      genUpper:'Büyük harf',
      genLower:'Küçük harf',
      genDigits:'Rakam',
      ...
      edit:'Düzenle',
      lblUser:'Kullanıcı',
      lblModified:'Değiştirilme',
      manageGroups:'Grupları Yönet',
      newGroupPlaceholder:'Yeni grup adı...',
      copied:'Kopyalandı',
      defaultGroup:'Genel',
    ...
    en: {
      ...
      newMasterPlaceholder:'Set new master password...',
    ...
    de: {
      vaultTitle:'Passwort-Tresor',
      enterMaster:'Geben Sie Ihr Master-Passwort ein',
      setMaster:'Neues Master-Passwort festlegen',
      masterPlaceholder:'Master-Passwort...',
      newMasterPlaceholder:'Neues Master-Passwort...',
      ...
      lblTitle:'Titel',
      titlePlaceholder:'z.B. Gmail',
      lblGroup:'Gruppe',
      lblUsername:'Benutzername',
      userPlaceholder:'benutzer@mail.com',
      lblPassword:'Passwort',
      lblUrl:'URL',
      lblNotes:'Notizen',
      genPassword:'Passwort generieren',
      genTitle:'Passwort-Generator',
      genLength:'Länge',
      genUpper:'Großbuchstaben',
      genLower:'Kleinbuchstaben',
      genDigits:'Ziffern',
      genSymbols:'Symbole',
      cancel:'Abbrechen',
      save:'Speichern',
    ...
    fr: {
      ...
      setMaster:'Définir un nouveau mot de passe principal',
      masterPlaceholder:'Mot de passe principal...',
      newMasterPlaceholder:'Nouveau mot de passe...',
      ...
      wrongPass:'Mauvais mot de passe principal',
      ...
      lblTitle:'Titre',
      titlePlaceholder:'ex: Gmail',
      lblGroup:'Groupe',
      lblUsername:'Nom d\'utilisateur',
      userPlaceholder:'utilisateur@mail.com',
      lblPassword:'Mot de passe',
      lblUrl:'URL',
      lblNotes:'Notes',
      genPassword:'Générer un mot de passe',
      ...
      newGroupPlaceholder:'Nouveau nom de groupe...',
      copied:'Copié',
      ...
      changePwError:'Le mot de passe actuel est incorrect'
    },
    es: {
      vaultTitle:'Bóveda de contraseñas',
      enterMaster:'Ingrese su contraseña maestra',
      setMaster:'Establezca una nueva contraseña maestra',
      masterPlaceholder:'Contraseña maestra...',
      newMasterPlaceholder:'Nueva contraseña maestra...',
      confirmPlaceholder:'Confirmar contraseña...',
      unlockBtn:'Desbloquear',
      createBtn:'Crear bóveda',
      passRequired:'Contraseña requerida',
      passMin6:'Al menos 6 caracteres',
      ...
      lblTitle:'Título',
      titlePlaceholder:'Ej: Gmail',
      lblGroup:'Grupo',
      lblUsername:'Usuario',
      userPlaceholder:'usuario@mail.com',
      lblPassword:'Contraseña',
      lblUrl:'URL',
      lblNotes:'Notas',
      genPassword:'Generar contraseña',
      ...
      changePwError:'La contraseña actual es incorrecta'
    },
    ru: {
      vaultTitle:'Хранилище паролей',
      enterMaster:'Введите мастер-пароль',
      setMaster:'Установите новый мастер-пароль',
      masterPlaceholder:'Мастер-пароль...',
      newMasterPlaceholder:'Новый мастер-пароль...',
      ...
      lblUrl:'URL',
      lblNotes:'Заметки',
      genPassword:'Сгенерировать пароль',
