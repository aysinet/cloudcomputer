(function(Vue) {
  ...
  const LANGS = {
    ...
    zh: { title: 'PDF Writer', newDoc: 'New Document', save: 'Save to Server', download: 'Download', addPage: 'Add Page', deletePage: 'Delete Page', pageOf: '/', bold: 'Bold', italic: 'Italic', underline: 'Underline', strikethrough: 'Strikethrough', alignLeft: 'Left', alignCenter: 'Center', alignRight: 'Right', alignJustify: 'Justify', fontSize: 'Font Size', fontFamily: 'Font', textColor: 'Color', insertImage: 'Insert Image', insertLine: 'Insert Line', insertTable: 'Insert Table', heading1: 'Heading 1', heading2: 'Heading 2', heading3: 'Heading 3', paragraph: 'Paragraph', fileName: 'File Name', unnamed: 'untitled', saving: 'Saving...', saved: 'PDF saved to server', saveFail: 'Save failed', generating: 'Generating PDF...', downloadReady: 'PDF ready', pageSize: 'Page Size', orientation: 'Orientation', portrait: 'Portrait', landscape: 'Landscape', margins: 'Margins', header: 'Header', footer: 'Footer', loading: 'Loading jsPDF...', loadFail: 'Failed to load jsPDF', undo: 'Undo', redo: 'Redo', bulletList: 'Bullet List', numberedList: 'Numbered List', columns: 'Columns', rows: 'Rows', insertTablePrompt: 'Choose table size', ok: 'OK', cancel: 'Cancel', page: 'Page', zoom: 'Zoom', headerPlaceholder: 'Header text...', footerPlaceholder: 'Footer text...', margin: 'Margin', top: 'Top', bottom: 'Bottom', left: 'Left', right: 'Right', preview: 'Preview', edit: 'Edit' },
    ja: { title: 'PDF Writer', newDoc: 'New Document', save: 'Save to Server', download: 'Download', addPage: 'Add Page', deletePage: 'Delete Page', pageOf: '/', bold: 'Bold', italic: 'Italic', underline: 'Underline', strikethrough: 'Strikethrough', alignLeft: 'Left', alignCenter: 'Center', alignRight: 'Right', alignJustify: 'Justify', fontSize: 'Font Size', fontFamily: 'Font', textColor: 'Color', insertImage: 'Insert Image', insertLine: 'Insert Line', insertTable: 'Insert Table', heading1: 'Heading 1', heading2: 'Heading 2', heading3: 'Heading 3', paragraph: 'Paragraph', fileName: 'File Name', unnamed: 'untitled', saving: 'Saving...', saved: 'PDF saved to server', saveFail: 'Save failed', generating: 'Generating PDF...', downloadReady: 'PDF ready', pageSize: 'Page Size', orientation: 'Orientation', portrait: 'Portrait', landscape: 'Landscape', margins: 'Margins', header: 'Header', footer: 'Footer', loading: 'Loading jsPDF...', loadFail: 'Failed to load jsPDF', undo: 'Undo', redo: 'Redo', bulletList: 'Bullet List', numberedList: 'Numbered List', columns: 'Columns', rows: 'Rows', insertTablePrompt: 'Choose table size', ok: 'OK', cancel: 'Cancel', page: 'Page', zoom: 'Zoom', headerPlaceholder: 'Header text...', footerPlaceholder: 'Footer text...', margin: 'Margin', top: 'Top', bottom: 'Bottom', left: 'Left', right: 'Right', preview: 'Preview', edit: 'Edit' },
    it: { title: 'PDF Writer', newDoc: 'New Document', save: 'Save to Server', download: 'Download', addPage: 'Add Page', deletePage: 'Delete Page', pageOf: '/', bold: 'Bold', italic: 'Italic', underline: 'Underline', strikethrough: 'Strikethrough', alignLeft: 'Left', alignCenter: 'Center', alignRight: 'Right', alignJustify: 'Justify', fontSize: 'Font Size', fontFamily: 'Font', textColor: 'Color', insertImage: 'Insert Image', insertLine: 'Insert Line', insertTable: 'Insert Table', heading1: 'Heading 1', heading2: 'Heading 2', heading3: 'Heading 3', paragraph: 'Paragraph', fileName: 'File Name', unnamed: 'untitled', saving: 'Saving...', saved: 'PDF saved to server', saveFail: 'Save failed', generating: 'Generating PDF...', downloadReady: 'PDF ready', pageSize: 'Page Size', orientation: 'Orientation', portrait: 'Portrait', landscape: 'Landscape', margins: 'Margins', header: 'Header', footer: 'Footer', loading: 'Loading jsPDF...', loadFail: 'Failed to load jsPDF', undo: 'Undo', redo: 'Redo', bulletList: 'Bullet List', numberedList: 'Numbered List', columns: 'Columns', rows: 'Rows', insertTablePrompt: 'Choose table size', ok: 'OK', cancel: 'Cancel', page: 'Page', zoom: 'Zoom', headerPlaceholder: 'Header text...', footerPlaceholder: 'Footer text...', margin: 'Margin', top: 'Top', bottom: 'Bottom', left: 'Left', right: 'Right', preview: 'Preview', edit: 'Edit' }
  };
