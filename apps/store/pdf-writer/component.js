(function(Vue) {
  ...
  const LANGS = {
    tr: {
      title:'PDF Oluşturucu',
      newDoc:'Yeni Belge',
      save:'Sunucuya Kaydet',
      download:'İndir',
      addPage:'Sayfa Ekle',
      ...
      unnamed:'isimsiz',
      saving:'Kaydediliyor...',
      saved:'PDF sunucuya kaydedildi',
      saveFail:'Kaydetme hatası',
      generating:'PDF oluşturuluyor...',
      downloadReady:'PDF hazır',
      ...
      header:'Üst Bilgi',
      footer:'Alt Bilgi',
      loading:'jsPDF yükleniyor...',
      loadFail:'jsPDF yüklenemedi',
      undo:'Geri Al',
      redo:'Yinele',
      bulletList:'Madde İşareti',
      numberedList:'Numaralı Liste',
      columns:'Sütun',
      rows:'Satır',
      insertTablePrompt:'Tablo boyutunu seçin',
      ok:'Tamam',
      cancel:'İptal',
      page:'Sayfa',
      zoom:'Yakınlaştır',
      headerPlaceholder:'Üst bilgi metni...',
      footerPlaceholder:'Alt bilgi metni...',
      margin:'Kenar',
      top:'Üst',
      bottom:'Alt',
      left:'Sol',
    ...
    en: {
      ...
      unnamed:'untitled',
      saving:'Saving...',
      saved:'PDF saved to server',
      saveFail:'Save failed',
      generating:'Generating PDF...',
      downloadReady:'PDF ready',
      pageSize:'Page Size',
      ...
      header:'Header',
      footer:'Footer',
      loading:'Loading jsPDF...',
      loadFail:'Failed to load jsPDF',
      undo:'Undo',
      redo:'Redo',
      ...
      columns:'Columns',
      rows:'Rows',
      insertTablePrompt:'Choose table size',
      ok:'OK',
      cancel:'Cancel',
      page:'Page',
      zoom:'Zoom',
    ...
    de: {
      ...
      saved:'PDF auf Server gespeichert',
      saveFail:'Speicherfehler',
      generating:'PDF wird erstellt...',
      downloadReady:'PDF bereit',
      ...
      header:'Kopfzeile',
      footer:'Fußzeile',
      loading:'jsPDF wird geladen...',
      loadFail:'jsPDF konnte nicht geladen werden',
      undo:'Rückgängig',
      redo:'Wiederholen',
      ...
      columns:'Spalten',
      rows:'Zeilen',
      insertTablePrompt:'Tabellengröße wählen',
      ok:'OK',
      cancel:'Abbrechen',
      page:'Seite',
      zoom:'Zoom',
      headerPlaceholder:'Kopfzeilentext...',
      footerPlaceholder:'Fußzeilentext...',
      margin:'Rand',
      top:'Oben',
      bottom:'Unten',
      left:'Links',
    ...
    fr: {
      ...
      saved:'PDF enregistré sur le serveur',
      saveFail:'Erreur d\'enregistrement',
      generating:'Génération du PDF...',
      downloadReady:'PDF prêt',
      ...
      header:'En-tête',
      footer:'Pied de page',
      loading:'Chargement de jsPDF...',
      loadFail:'Impossible de charger jsPDF',
      undo:'Annuler',
      redo:'Rétablir',
      ...
      columns:'Colonnes',
      rows:'Lignes',
      insertTablePrompt:'Choisir la taille du tableau',
      ok:'OK',
      cancel:'Annuler',
      page:'Page',
      zoom:'Zoom',
      headerPlaceholder:'Texte d\'en-tête...',
      footerPlaceholder:'Texte de pied de page...',
      margin:'Marge',
      top:'Haut',
      bottom:'Bas',
      left:'Gauche',
    ...
    es: {
      ...
      unnamed:'sin_nombre',
      saving:'Guardando...',
      saved:'PDF guardado en el servidor',
      saveFail:'Error al guardar',
      generating:'Generando PDF...',
      downloadReady:'PDF listo',
      ...
      loading:'Cargando jsPDF...',
      loadFail:'No se pudo cargar jsPDF',
      undo:'Deshacer',
      redo:'Rehacer',
      ...
      columns:'Columnas',
      rows:'Filas',
      insertTablePrompt:'Elegir tamaño de tabla',
      ok:'Aceptar',
      cancel:'Cancelar',
      page:'Página',
      zoom:'Zoom',
      headerPlaceholder:'Texto de encabezado...',
      footerPlaceholder:'Texto de pie de página...',
      margin:'Margen',
      top:'Arriba',
      bottom:'Abajo',
      left:'Izquierda',
    ...
    ru: {
      ...
      unnamed:'без_имени',
      saving:'Сохранение...',
      saved:'PDF сохранён на сервере',
      saveFail:'Ошибка сохранения',
      generating:'Создание PDF...',
      downloadReady:'PDF готов',
      ...
      loading:'Загрузка jsPDF...',
      loadFail:'Не удалось загрузить jsPDF',
      undo:'Отмена',
      redo:'Повтор',
      ...
      columns:'Столбцы',
      rows:'Строки',
      insertTablePrompt:'Выберите размер таблицы',
      ok:'ОК',
      cancel:'Отмена',
      page:'Страница',
      zoom:'Масштаб',
      headerPlaceholder:'Текст верхнего колонтитулыа...',
      footerPlaceholder:'Текст нижнего колонтитула...',
      margin:'Поле',
      top:'Верх',
      bottom:'Низ',
      left:'Лево',
    ...
    zh: {
      ...
      columns:'列',
      rows:'行',
      insertTablePrompt:'插入表格',
      ok:'确定',
      cancel:'取消',
      page:'页',
      zoom:'缩放',
      headerPlaceholder:'输入页眉...',
      footerPlaceholder:'输入页脚...',
      margin:'边距',
      top:'上',
      bottom:'下',
      left:'左',
    ...
    ja: {
      ...
      columns:'列',
      rows:'行',
      insertTablePrompt:'表を挿入',
      ok:'OK',
      cancel:'キャンセル',
      page:'ページ',
      zoom:'ズーム',
      headerPlaceholder:'ヘッダーを入力...',
      footerPlaceholder:'フッターを入力...',
      margin:'余白',
      top:'上',
      bottom:'下',
      left:'左',
    ...
    it: {
      ...
      columns:'Colonne',
      rows:'Righe',
      insertTablePrompt:'Inserisci tabella',
      ok:'OK',
      cancel:'Annulla',
      page:'Pagina',
      zoom:'Zoom',
      headerPlaceholder:'Inserisci intestazione...',
      footerPlaceholder:'Inserisci piè di pagina...',
      margin:'Margine',
      top:'Alto',
      bottom:'Basso',
      left:'Sinistra',
