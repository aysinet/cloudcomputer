({
  setup() {
    ...
    const LANGS = {
      tr: {
        title:'Formül Editörü',
        latex:'LaTeX Kodu',
        preview:'Önizleme',
        symbols:'Semboller',
        library:'Kütüphane',
        myFormulas:'Formüllerim',
        save:'Kaydet',
        delete:'Sil',
        exportPng:'PNG olarak kaydet',
        exportSvg:'SVG olarak kaydet',
        exportLatex:'LaTeX olarak kaydet',
        exportMathml:'MathML olarak kaydet',
        exportMenu:'Dışa Aktar',
        copy:'Kopyala',
        copyLatex:'LaTeX Kopyala',
        copyMathml:'MathML Kopyala',
        name:'İsim',
        nameRequired:'İsim gerekli',
        saved:'Kaydedildi',
        deleted:'Silindi',
        copied:'Panoya kopyalandı',
        deleteConfirm:'Bu formülü silmek istediğinize emin misiniz?',
        yes:'Evet',
        cancel:'İptal',
        noFormulas:'Henüz formül yok',
        loading:'KaTeX yükleniyor...',
        error:'Hata',
        placeholder:'LaTeX kodu yazın...',
        namePlaceholder:'Formül adı',
        ...
        libStats:'İstatistik',
        libPhysics:'Fizik',
        libLinAlg:'Lineer Cebir',
        saveToServer:'Sunucuya Kaydet',
        savedToServer:'Sunucuya kaydedildi',
        loadError:'Formüller yüklenemedi',
      ...
      en: {
        ...
        exportLatex:'Save as LaTeX',
        exportMathml:'Save as MathML',
        exportMenu:'Export',
        copy:'Copy',
        ...
        deleteConfirm:'Are you sure you want to delete this formula?',
        yes:'Yes',
        cancel:'Cancel',
        noFormulas:'No formulas yet',
        loading:'Loading KaTeX...',
        error:'Error',
        placeholder:'Type LaTeX code...',
        namePlaceholder:'Formula name',
        fontSize:'Font size',
        color:'Color',
        bgColor:'Background',
        ...
        libStats:'Statistics',
        libPhysics:'Physics',
        libLinAlg:'Linear Algebra',
        saveToServer:'Save to Server',
        savedToServer:'Saved to server',
        loadError:'Could not load formulas',
      ...
      de: {
        ...
        exportLatex:'Als LaTeX speichern',
        exportMathml:'Als MathML speichern',
        exportMenu:'Exportieren',
        copy:'Kopieren',
        copyLatex:'LaTeX kopieren',
        copyMathml:'MathML kopieren',
        name:'Name',
        nameRequired:'Name ist erforderlich',
        saved:'Gespeichert',
        deleted:'Gelöscht',
        copied:'In Zwischenablage kopiert',
        deleteConfirm:'Möchten Sie diese Formel wirklich löschen?',
        yes:'Ja',
        cancel:'Abbrechen',
        noFormulas:'Noch keine Formeln',
        loading:'KaTeX wird geladen...',
        error:'Fehler',
        placeholder:'LaTeX-Code eingeben...',
        namePlaceholder:'Formelname',
        ...
        libStats:'Statistik',
        libPhysics:'Physik',
        libLinAlg:'Lineare Algebra',
        saveToServer:'Auf Server speichern',
        savedToServer:'Auf Server gespeichert',
        loadError:'Formeln konnten nicht geladen werden',
      ...
      fr: {
        ...
        exportSvg:'Enregistrer en SVG',
        exportLatex:'Enregistrer en LaTeX',
        exportMathml:'Enregistrer en MathML',
        exportMenu:'Exporter',
        copy:'Copier',
        copyLatex:'Copier LaTeX',
        copyMathml:'Copier MathML',
        name:'Nom',
        nameRequired:'Le nom est requis',
        saved:'Enregistré',
        deleted:'Supprimé',
        copied:'Copié dans le presse-papiers',
        deleteConfirm:'Êtes-vous sûr de vouloir supprimer cette formule ?',
        yes:'Oui',
        cancel:'Annuler',
        noFormulas:'Aucune formule',
        loading:'Chargement de KaTeX...',
        error:'Erreur',
        placeholder:'Tapez du code LaTeX...',
        namePlaceholder:'Nom de la formule',
        fontSize:'Taille',
        color:'Couleur',
        ...
        catCalc:'Calcul',
        catMatrix:'Matrice',
        catTrig:'Trigonométrie',
        catMisc:'Divers',
        libAlgebra:'Algèbre',
        libCalc:'Calcul',
        libGeom:'Géométrie',
        libStats:'Statistiques',
        libPhysics:'Physique',
        libLinAlg:'Algèbre Linéaire',
        saveToServer:'Sauver sur le serveur',
        savedToServer:'Sauvé sur le serveur',
        loadError:'Impossible de charger les formules',
      ...
      es: {
        ...
        exportLatex:'Guardar como LaTeX',
        exportMathml:'Guardar como MathML',
        exportMenu:'Exportar',
        copy:'Copiar',
        ...
        deleteConfirm:'¿Estás seguro de que quieres eliminar esta fórmula?',
        yes:'Sí',
        cancel:'Cancelar',
        noFormulas:'Aún no hay fórmulas',
        loading:'Cargando KaTeX...',
        error:'Error',
        placeholder:'Escriba código LaTeX...',
        namePlaceholder:'Nombre de la fórmula',
        fontSize:'Tamaño',
        color:'Color',
        bgColor:'Fondo',
        ...
        catCalc:'Cálculo',
        catMatrix:'Matriz',
        catTrig:'Trigonometría',
        catMisc:'Varios',
        libAlgebra:'Álgebra',
        libCalc:'Cálculo',
        libGeom:'Geometría',
        libStats:'Estadística',
        libPhysics:'Física',
        libLinAlg:'Álgebra Lineal',
        saveToServer:'Guardar en servidor',
        savedToServer:'Guardado en servidor',
        loadError:'No se pudieron cargar las fórmulas',
      ...
      ru: {
        ...
        symbols:'Символы',
        library:'Библиотека',
        myFormulas:'Мои Формулы',
        save:'Сохранить',
        delete:'Удалить',
        exportPng:'Сохранить как PNG',
        exportSvg:'Сохранить как SVG',
        exportLatex:'Сохранить как LaTeX',
        exportMathml:'Сохранить как MathML',
        exportMenu:'Экспорт',
        copy:'Копировать',
        copyLatex:'Копировать LaTeX',
        copyMathml:'Копировать MathML',
        name:'Имя',
        nameRequired:'Имя обязательно',
        saved:'Сохранено',
        deleted:'Удалено',
        copied:'Скопировано в буфер',
        deleteConfirm:'Вы уверены, что хотите удалить эту формулу?',
        yes:'Да',
        cancel:'Отмена',
        noFormulas:'Пока нет формул',
        loading:'Загрузка KaTeX...',
        error:'Ошибка',
        placeholder:'Введите код LaTeX...',
        namePlaceholder:'Название формулы',
        fontSize:'Размер',
        color:'Цвет',
        bgColor:'Фон',
        ...
        libStats:'Статистика',
        libPhysics:'Физика',
        libLinAlg:'Линейная алгебра',
        saveToServer:'Сохранить на сервер',
        savedToServer:'Сохранено на сервер',
        loadError:'Не удалось загрузить формулы',
      ...
      ja: {
        ...
        exportSvg:'SVG出力',
        exportLatex:'LaTeX出力',
        exportMathml:'MathML出力',
        exportMenu:'エクスポートメニュー',
        copy:'コピー',
        copyLatex:'LaTeXコピー',
        copyMathml:'MathMLコピー',
        name:'名前',
        ...
        savedToServer:'サーバーに保存済',
        loadError:'読込エラー',
        insertTemplate:'テンプレート挿入'
      },
      it: {
        title:'Editor Formule',
        latex:'Codice LaTeX',
        preview:'Anteprima',
        symbols:'Simboli',
        library:'Libreria formule',
        myFormulas:'Le mie formule',
        save:'Salva',
        delete:'Elimina',
        exportPng:'Esporta PNG',
        exportSvg:'Esporta SVG',
        exportLatex:'Esporta LaTeX',
        exportMathml:'Esporta MathML',
        exportMenu:'Menu esportazione',
        copy:'Copia',
        ...
        yes:'Sì',
        cancel:'Annulla',
        noFormulas:'Nessuna formula',
        loading:'Caricamento',
        error:'Errore',
        placeholder:'Inserisci formula LaTeX...',
        namePlaceholder:'Nome formula',
        ...
        libStats:'Statistica',
        libPhysics:'Fisica',
        libLinAlg:'Algebra lineare',
        saveToServer:'Salva sul server',
      ...
      hi: {
        ...
        copyMathml:'Copy MathML',
        name:'नाम',
        nameRequired:'कार्य का नाम आवश्यक',
        saved:'सहेजा गया',
        deleted:'Deleted',
