({
  setup() {
    ...
    zh: { title:'公式编辑器', latex:'LaTeX代码', preview:'预览', symbols:'符号', library:'公式库', myFormulas:'我的公式', save:'保存', delete:'删除', exportPng:'导出PNG', exportSvg:'导出SVG', exportLatex:'导出LaTeX', exportMathml:'导出MathML', exportMenu:'导出菜单', copy:'复制', copyLatex:'复制LaTeX', copyMathml:'复制MathML', name:'名称', nameRequired:'请输入名称', saved:'已保存', deleted:'已删除', copied:'已复制', deleteConfirm:'确认删除？', yes:'是', cancel:'取消', noFormulas:'没有公式', loading:'加载中', error:'错误', placeholder:'输入LaTeX公式...', namePlaceholder:'公式名称', fontSize:'字体大小', color:'颜色', bgColor:'背景色', transparent:'透明', padding:'内边距', catBasic:'基础', catGreek:'希腊字母', catOps:'运算符', catRel:'关系', catArrows:'箭头', catSets:'集合', catCalc:'微积分', catMatrix:'矩阵', catTrig:'三角函数', catMisc:'其他', libAlgebra:'代数', libCalc:'微积分', libGeom:'几何', libStats:'统计', libPhysics:'物理', libLinAlg:'线性代数', saveToServer:'保存到服务器', savedToServer:'已保存到服务器', loadError:'加载失败', insertTemplate:'插入模板' },
    ja: { title:'数式エディタ', latex:'LaTeXコード', preview:'プレビュー', symbols:'記号', library:'数式ライブラリ', myFormulas:'マイ数式', save:'保存', delete:'削除', exportPng:'PNG出力', exportSvg:'SVG出力', exportLatex:'LaTeX出力', exportMathml:'MathML出力', exportMenu:'エクスポートメニュー', copy:'コピー', copyLatex:'LaTeXコピー', copyMathml:'MathMLコピー', name:'名前', nameRequired:'名前を入力してください', saved:'保存済', deleted:'削除済', copied:'コピー済', deleteConfirm:'削除しますか？', yes:'はい', cancel:'キャンセル', noFormulas:'数式なし', loading:'読込中', error:'エラー', placeholder:'LaTeX数式を入力...', namePlaceholder:'数式名', fontSize:'文字サイズ', color:'色', bgColor:'背景色', transparent:'透明', padding:'パディング', catBasic:'基本', catGreek:'ギリシャ文字', catOps:'演算子', catRel:'関係', catArrows:'矢印', catSets:'集合', catCalc:'微積分', catMatrix:'行列', catTrig:'三角関数', catMisc:'その他', libAlgebra:'代数', libCalc:'微積分', libGeom:'幾何', libStats:'統計', libPhysics:'物理', libLinAlg:'線形代数', saveToServer:'サーバーに保存', savedToServer:'サーバーに保存済', loadError:'読込エラー', insertTemplate:'テンプレート挿入' },
    it: { title:'Editor Formule', latex:'Codice LaTeX', preview:'Anteprima', symbols:'Simboli', library:'Libreria formule', myFormulas:'Le mie formule', save:'Salva', delete:'Elimina', exportPng:'Esporta PNG', exportSvg:'Esporta SVG', exportLatex:'Esporta LaTeX', exportMathml:'Esporta MathML', exportMenu:'Menu esportazione', copy:'Copia', copyLatex:'Copia LaTeX', copyMathml:'Copia MathML', name:'Nome', nameRequired:'Nome richiesto', saved:'Salvato', deleted:'Eliminato', copied:'Copiato', deleteConfirm:'Confermi eliminazione?', yes:'Sì', cancel:'Annulla', noFormulas:'Nessuna formula', loading:'Caricamento', error:'Errore', placeholder:'Inserisci formula LaTeX...', namePlaceholder:'Nome formula', fontSize:'Dimensione testo', color:'Colore', bgColor:'Colore sfondo', transparent:'Trasparente', padding:'Spaziatura', catBasic:'Base', catGreek:'Lettere greche', catOps:'Operatori', catRel:'Relazioni', catArrows:'Frecce', catSets:'Insiemi', catCalc:'Calcolo', catMatrix:'Matrici', catTrig:'Trigonometria', catMisc:'Varie', libAlgebra:'Algebra', libCalc:'Calcolo', libGeom:'Geometria', libStats:'Statistica', libPhysics:'Fisica', libLinAlg:'Algebra lineare', saveToServer:'Salva sul server', savedToServer:'Salvato sul server', loadError:'Errore caricamento', insertTemplate:'Inserisci modello' }
  };
