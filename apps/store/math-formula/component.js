({
  setup() {
    ...
    zh: { title: 'Formula Editor', latex: 'LaTeX Code', preview: 'Preview', symbols: 'Symbols', library: 'Library', myFormulas: 'My Formulas', save: 'Save', delete: 'Delete', exportPng: 'Save as PNG', exportSvg: 'Save as SVG', exportLatex: 'Save as LaTeX', exportMathml: 'Save as MathML', exportMenu: 'Export', copy: 'Copy', copyLatex: 'Copy LaTeX', copyMathml: 'Copy MathML', name: 'Name', nameRequired: 'Name is required', saved: 'Saved', deleted: 'Deleted', copied: 'Copied to clipboard', deleteConfirm: 'Are you sure you want to delete this formula?', yes: 'Yes', cancel: 'Cancel', noFormulas: 'No formulas yet', loading: 'Loading KaTeX...', error: 'Error', placeholder: 'Type LaTeX code...', namePlaceholder: 'Formula name', fontSize: 'Font size', color: 'Color', bgColor: 'Background', transparent: 'Transparent', padding: 'Padding', catBasic: 'Basic', catGreek: 'Greek', catOps: 'Operators', catRel: 'Relations', catArrows: 'Arrows', catSets: 'Sets', catCalc: 'Calculus', catMatrix: 'Matrix', catTrig: 'Trigonometry', catMisc: 'Misc', libAlgebra: 'Algebra', libCalc: 'Calculus', libGeom: 'Geometry', libStats: 'Statistics', libPhysics: 'Physics', libLinAlg: 'Linear Algebra', saveToServer: 'Save to Server', savedToServer: 'Saved to server', loadError: 'Could not load formulas', insertTemplate: 'Insert Template' },
    ja: { title: 'Formula Editor', latex: 'LaTeX Code', preview: 'Preview', symbols: 'Symbols', library: 'Library', myFormulas: 'My Formulas', save: 'Save', delete: 'Delete', exportPng: 'Save as PNG', exportSvg: 'Save as SVG', exportLatex: 'Save as LaTeX', exportMathml: 'Save as MathML', exportMenu: 'Export', copy: 'Copy', copyLatex: 'Copy LaTeX', copyMathml: 'Copy MathML', name: 'Name', nameRequired: 'Name is required', saved: 'Saved', deleted: 'Deleted', copied: 'Copied to clipboard', deleteConfirm: 'Are you sure you want to delete this formula?', yes: 'Yes', cancel: 'Cancel', noFormulas: 'No formulas yet', loading: 'Loading KaTeX...', error: 'Error', placeholder: 'Type LaTeX code...', namePlaceholder: 'Formula name', fontSize: 'Font size', color: 'Color', bgColor: 'Background', transparent: 'Transparent', padding: 'Padding', catBasic: 'Basic', catGreek: 'Greek', catOps: 'Operators', catRel: 'Relations', catArrows: 'Arrows', catSets: 'Sets', catCalc: 'Calculus', catMatrix: 'Matrix', catTrig: 'Trigonometry', catMisc: 'Misc', libAlgebra: 'Algebra', libCalc: 'Calculus', libGeom: 'Geometry', libStats: 'Statistics', libPhysics: 'Physics', libLinAlg: 'Linear Algebra', saveToServer: 'Save to Server', savedToServer: 'Saved to server', loadError: 'Could not load formulas', insertTemplate: 'Insert Template' },
    it: { title: 'Formula Editor', latex: 'LaTeX Code', preview: 'Preview', symbols: 'Symbols', library: 'Library', myFormulas: 'My Formulas', save: 'Save', delete: 'Delete', exportPng: 'Save as PNG', exportSvg: 'Save as SVG', exportLatex: 'Save as LaTeX', exportMathml: 'Save as MathML', exportMenu: 'Export', copy: 'Copy', copyLatex: 'Copy LaTeX', copyMathml: 'Copy MathML', name: 'Name', nameRequired: 'Name is required', saved: 'Saved', deleted: 'Deleted', copied: 'Copied to clipboard', deleteConfirm: 'Are you sure you want to delete this formula?', yes: 'Yes', cancel: 'Cancel', noFormulas: 'No formulas yet', loading: 'Loading KaTeX...', error: 'Error', placeholder: 'Type LaTeX code...', namePlaceholder: 'Formula name', fontSize: 'Font size', color: 'Color', bgColor: 'Background', transparent: 'Transparent', padding: 'Padding', catBasic: 'Basic', catGreek: 'Greek', catOps: 'Operators', catRel: 'Relations', catArrows: 'Arrows', catSets: 'Sets', catCalc: 'Calculus', catMatrix: 'Matrix', catTrig: 'Trigonometry', catMisc: 'Misc', libAlgebra: 'Algebra', libCalc: 'Calculus', libGeom: 'Geometry', libStats: 'Statistics', libPhysics: 'Physics', libLinAlg: 'Linear Algebra', saveToServer: 'Save to Server', savedToServer: 'Saved to server', loadError: 'Could not load formulas', insertTemplate: 'Insert Template' }
  };
