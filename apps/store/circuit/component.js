(function(Vue) {
  ...
  const LANGS = {
    ...
    zh: { title:'电路设计器', components:'元件', properties:'属性', tools:'工具', select:'选择', wire:'导线', delete:'删除', rotate:'旋转', zoomIn:'放大', zoomOut:'缩小', zoomFit:'适应', undo:'撤销', redo:'重做', newFile:'新建', save:'保存', load:'加载', exportPng:'导出PNG', name:'名称', value:'值', rotation:'旋转', resistor:'电阻', capacitor:'电容', inductor:'电感', diode:'二极管', led:'发光二极管', zener:'稳压二极管', npn:'NPN晶体管', pnp:'PNP晶体管', mosfetN:'N-MOSFET', mosfetP:'P-MOSFET', opamp:'运算放大器', ic:'集成电路', battery:'电池', gnd:'接地', vcc:'电源', switchComp:'开关', fuse:'保险丝', crystal:'晶振', transformer:'变压器', relay:'继电器', potentiometer:'电位器', speaker:'扬声器', microphone:'麦克风', motor:'电机', catPassive:'无源元件', catActive:'有源元件', catPower:'电源', catIO:'输入/输出', catIC:'集成电路', catElectro:'机电元件', noSelection:'未选中', saved:'已保存', loaded:'已加载', deleteConfirm:'确认删除？', gridSnap:'网格吸附', showGrid:'显示网格', snapToGrid:'吸附到网格', circuitName:'电路名称', unnamed:'未命名', netlist:'网表', copyNetlist:'复制网表', copied:'已复制', x:'X', y:'Y', id:'ID', pins:'引脚', wires:'导线', totalComponents:'元件总数' },
    ja: { title:'回路デザイナー', components:'部品', properties:'プロパティ', tools:'ツール', select:'選択', wire:'配線', delete:'削除', rotate:'回転', zoomIn:'拡大', zoomOut:'縮小', zoomFit:'全体表示', undo:'元に戻す', redo:'やり直し', newFile:'新規', save:'保存', load:'読込', exportPng:'PNG出力', name:'名前', value:'値', rotation:'回転', resistor:'抵抗', capacitor:'コンデンサ', inductor:'インダクタ', diode:'ダイオード', led:'LED', zener:'ツェナーダイオード', npn:'NPNトランジスタ', pnp:'PNPトランジスタ', mosfetN:'N-MOSFET', mosfetP:'P-MOSFET', opamp:'オペアンプ', ic:'IC', battery:'バッテリー', gnd:'グランド', vcc:'電源', switchComp:'スイッチ', fuse:'ヒューズ', crystal:'水晶振動子', transformer:'トランス', relay:'リレー', potentiometer:'可変抵抗', speaker:'スピーカー', microphone:'マイク', motor:'モーター', catPassive:'受動部品', catActive:'能動部品', catPower:'電源', catIO:'入出力', catIC:'集積回路', catElectro:'電気機械', noSelection:'選択なし', saved:'保存済', loaded:'読込済', deleteConfirm:'削除しますか？', gridSnap:'グリッド吸着', showGrid:'グリッド表示', snapToGrid:'グリッドに吸着', circuitName:'回路名', unnamed:'無題', netlist:'ネットリスト', copyNetlist:'ネットリストをコピー', copied:'コピー済', x:'X', y:'Y', id:'ID', pins:'ピン', wires:'配線', totalComponents:'部品数' },
    it: { title:'Progettista Circuiti', components:'Componenti', properties:'Proprietà', tools:'Strumenti', select:'Seleziona', wire:'Filo', delete:'Elimina', rotate:'Ruota', zoomIn:'Ingrandisci', zoomOut:'Riduci', zoomFit:'Adatta', undo:'Annulla', redo:'Ripristina', newFile:'Nuovo', save:'Salva', load:'Carica', exportPng:'Esporta PNG', name:'Nome', value:'Valore', rotation:'Rotazione', resistor:'Resistore', capacitor:'Condensatore', inductor:'Induttore', diode:'Diodo', led:'LED', zener:'Zener', npn:'NPN', pnp:'PNP', mosfetN:'N-MOSFET', mosfetP:'P-MOSFET', opamp:'Amp. operazionale', ic:'Circuito integrato', battery:'Batteria', gnd:'Massa', vcc:'Alimentazione', switchComp:'Interruttore', fuse:'Fusibile', crystal:'Cristallo', transformer:'Trasformatore', relay:'Relè', potentiometer:'Potenziometro', speaker:'Altoparlante', microphone:'Microfono', motor:'Motore', catPassive:'Passivi', catActive:'Attivi', catPower:'Alimentazione', catIO:'I/O', catIC:'Circuiti integrati', catElectro:'Elettromeccanici', noSelection:'Nessuna selezione', saved:'Salvato', loaded:'Caricato', deleteConfirm:'Confermi eliminazione?', gridSnap:'Aggancia griglia', showGrid:'Mostra griglia', snapToGrid:'Aggancia alla griglia', circuitName:'Nome circuito', unnamed:'Senza nome', netlist:'Netlist', copyNetlist:'Copia netlist', copied:'Copiato', x:'X', y:'Y', id:'ID', pins:'Pin', wires:'Fili', totalComponents:'Totale componenti' }
  };
