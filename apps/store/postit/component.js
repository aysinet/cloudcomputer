({
  setup() {
    ...
    const LANGS = {
      tr: {
        title:'PostIt Notlar', newPostit:'Yeni PostIt', noPostits:'Henüz postit yok',
        empty:'Boş not', deleteConfirm:'Bu notu silmek istediğinize emin misiniz?',
        delete:'Sil', yes:'Evet', cancel:'İptal', hide:'Gizle', show:'Göster',
        showAll:'Tümünü Göster', hideAll:'Tümünü Gizle', loading:'Yükleniyor...',
        placeholder:'Not yazın...', yellow:'Sarı', pink:'Pembe', blue:'Mavi',
        green:'Yeşil', purple:'Mor', orange:'Turuncu', color:'Renk',
        manager:'Yönetici', notes:'not'
      },
      en: {
        title:'PostIt Notes', newPostit:'New PostIt', noPostits:'No postits yet',
        empty:'Empty note', deleteConfirm:'Are you sure you want to delete this note?',
        delete:'Delete', yes:'Yes', cancel:'Cancel', hide:'Hide', show:'Show',
        showAll:'Show All', hideAll:'Hide All', loading:'Loading...',
        placeholder:'Write a note...', yellow:'Yellow', pink:'Pink', blue:'Blue',
        green:'Green', purple:'Purple', orange:'Orange', color:'Color',
        manager:'Manager', notes:'notes'
      },
      de: {
        title:'PostIt Notizen', newPostit:'Neue Notiz', noPostits:'Noch keine Notizen',
        empty:'Leere Notiz', deleteConfirm:'Möchten Sie diese Notiz wirklich löschen?',
        delete:'Löschen', yes:'Ja', cancel:'Abbrechen', hide:'Ausblenden', show:'Einblenden',
        showAll:'Alle anzeigen', hideAll:'Alle ausblenden', loading:'Laden...',
        placeholder:'Notiz schreiben...', yellow:'Gelb', pink:'Rosa', blue:'Blau',
        green:'Grün', purple:'Lila', orange:'Orange', color:'Farbe',
        manager:'Verwaltung', notes:'Notizen'
      },
      fr: {
        title:'Notes PostIt', newPostit:'Nouvelle Note', noPostits:'Aucune note',
        empty:'Note vide', deleteConfirm:'Êtes-vous sûr de vouloir supprimer cette note ?',
        delete:'Supprimer', yes:'Oui', cancel:'Annuler', hide:'Masquer', show:'Afficher',
        showAll:'Tout afficher', hideAll:'Tout masquer', loading:'Chargement...',
        placeholder:'Écrire une note...', yellow:'Jaune', pink:'Rose', blue:'Bleu',
        green:'Vert', purple:'Violet', orange:'Orange', color:'Couleur',
        manager:'Gestionnaire', notes:'notes'
      },
      es: {
        title:'Notas PostIt', newPostit:'Nueva Nota', noPostits:'Aún no hay notas',
        empty:'Nota vacía', deleteConfirm:'¿Estás seguro de que quieres eliminar esta nota?',
        delete:'Eliminar', yes:'Sí', cancel:'Cancelar', hide:'Ocultar', show:'Mostrar',
        showAll:'Mostrar todo', hideAll:'Ocultar todo', loading:'Cargando...',
        placeholder:'Escribir una nota...', yellow:'Amarillo', pink:'Rosa', blue:'Azul',
        green:'Verde', purple:'Morado', orange:'Naranja', color:'Color',
        manager:'Gestor', notes:'notas'
      },
      ru: {
        title:'PostIt Заметки', newPostit:'Новая заметка', noPostits:'Пока нет заметок',
        empty:'Пустая заметка', deleteConfirm:'Вы уверены, что хотите удалить эту заметку?',
        delete:'Удалить', yes:'Да', cancel:'Отмена', hide:'Скрыть', show:'Показать',
        showAll:'Показать все', hideAll:'Скрыть все', loading:'Загрузка...',
